...
import krapper.clangwalk.internal.clang_CXXRecordDecl_added_eligible_special_member_function
import krapper.clangwalk.internal.clang_CXXRecordDecl_align_of
import krapper.clangwalk.internal.clang_CXXRecordDecl_allow_const_default_init
import krapper.clangwalk.internal.clang_CXXRecordDecl_as_clang_Decl
import krapper.clangwalk.internal.clang_CXXRecordDecl_as_clang_DeclContext
import krapper.clangwalk.internal.clang_CXXRecordDecl_as_clang_NamedDecl
import krapper.clangwalk.internal.clang_CXXRecordDecl_as_clang_RecordDecl
import krapper.clangwalk.internal.clang_CXXRecordDecl_as_clang_TagDecl
import krapper.clangwalk.internal.clang_CXXRecordDecl_as_clang_TypeDecl
import krapper.clangwalk.internal.clang_CXXRecordDecl_bases
import krapper.clangwalk.internal.clang_CXXRecordDecl_calculate_inheritance_model
import krapper.clangwalk.internal.clang_CXXRecordDecl_capture_size
import krapper.clangwalk.internal.clang_CXXRecordDecl_classof
import krapper.clangwalk.internal.clang_CXXRecordDecl_classof_kind
import krapper.clangwalk.internal.clang_CXXRecordDecl_complete_definition
import krapper.clangwalk.internal.clang_CXXRecordDecl_defaulted_copy_constructor_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_defaulted_default_constructor_is_constexpr
import krapper.clangwalk.internal.clang_CXXRecordDecl_defaulted_destructor_is_constexpr
import krapper.clangwalk.internal.clang_CXXRecordDecl_defaulted_destructor_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_defaulted_move_constructor_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_finished_defaulted_or_deleted_member
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_canonical_decl
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_definition
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_definition_or_self
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_device_lambda_mangling_number
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_instantiated_from_member_class
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_call_operator
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_capture_default
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_context_decl
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_dependency_kind
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_index_in_context
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_mangling_number
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_static_invoker
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_lambda_static_invoker__clang_CallingConv
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_most_recent_decl
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_ms_inheritance_model
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_num_bases
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_num_v_bases
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_odr_hash
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_previous_decl
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_standard_layout_base_with_fields
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_template_instantiation_pattern
import krapper.clangwalk.internal.clang_CXXRecordDecl_get_template_specialization_kind
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_any_dependent_bases
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_constexpr_default_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_constexpr_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_constexpr_non_copy_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_copy_assignment_with_const_param
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_copy_constructor_with_const_param
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_default_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_definition
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_deleted_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_direct_fields
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_friends
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_in_class_initializer
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_inherited_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_inherited_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_init_method
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_injected_class_type
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_irrelevant_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_known_lambda_internal_linkage
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_mutable_fields
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_literal_type_fields_or_bases
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_copy_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_copy_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_copy_constructor_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_default_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_destructor_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_non_trivial_move_constructor_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_private_fields
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_protected_fields
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_simple_copy_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_simple_copy_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_simple_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_simple_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_simple_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_copy_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_copy_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_copy_constructor_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_default_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_destructor_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_trivial_move_constructor_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_uninitialized_reference_member
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_copy_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_copy_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_declared_move_operation
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_user_provided_default_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_has_variant_members
import krapper.clangwalk.internal.clang_CXXRecordDecl_implicit_copy_assignment_has_const_param
import krapper.clangwalk.internal.clang_CXXRecordDecl_implicit_copy_constructor_has_const_param
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_abstract
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_aggregate
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_any_destructor_no_return
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_c_like
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_captureless_lambda
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_current_instantiation
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_cxx11standard_layout
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_dependent_lambda
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_derived_from
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_dynamic_class
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_effectively_final
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_empty
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_generic_lambda
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_hlsl_intangible
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_injected_class_name
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_interface_like
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_lambda
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_literal
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_local_class
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_never_dependent_lambda
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_parsing_base_specifiers
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_pod
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_polymorphic
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_provably_not_derived_from
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_standard_layout
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_structural
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_trivial
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_trivially_copy_constructible
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_trivially_copyable
import krapper.clangwalk.internal.clang_CXXRecordDecl_is_virtually_derived_from
import krapper.clangwalk.internal.clang_CXXRecordDecl_lambda_is_default_constructible_and_assignable
import krapper.clangwalk.internal.clang_CXXRecordDecl_mark_abstract
import krapper.clangwalk.internal.clang_CXXRecordDecl_may_be_abstract
import krapper.clangwalk.internal.clang_CXXRecordDecl_may_be_dynamic_class
import krapper.clangwalk.internal.clang_CXXRecordDecl_may_be_non_dynamic_class
import krapper.clangwalk.internal.clang_CXXRecordDecl_merge_access
import krapper.clangwalk.internal.clang_CXXRecordDecl_methods
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_implicit_copy_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_implicit_copy_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_implicit_default_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_implicit_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_implicit_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_implicit_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_overload_resolution_for_copy_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_overload_resolution_for_copy_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_overload_resolution_for_destructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_overload_resolution_for_move_assignment
import krapper.clangwalk.internal.clang_CXXRecordDecl_needs_overload_resolution_for_move_constructor
import krapper.clangwalk.internal.clang_CXXRecordDecl_null_field_offset_is_zero
import krapper.clangwalk.internal.clang_CXXRecordDecl_remove_conversion
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_has_trivial_special_member_for_call
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_implicit_copy_assignment_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_implicit_copy_constructor_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_implicit_destructor_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_implicit_move_assignment_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_implicit_move_constructor_is_deleted
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_init_method
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_instantiation_of_member_class
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_is_parsing_base_specifiers
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_lambda_dependency_kind
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_lambda_is_generic
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_template_specialization_kind
import krapper.clangwalk.internal.clang_CXXRecordDecl_set_trivial_for_call_flags
import krapper.clangwalk.internal.clang_CXXRecordDecl_size_of
import krapper.clangwalk.internal.clang_CXXRecordDecl_vbases
import krapper.clangwalk.internal.clang_CXXRecordDecl_view_inheritance
...
class CXXRecordDecl(
    ...
    inline fun methods(): Vector__CXXMethodDecl_P {
        val retValue: Vector__CXXMethodDecl_P = memScope.Vector__CXXMethodDecl_P_Holder()
        clang_CXXRecordDecl_methods(ptr, retValue.ptr)
        return retValue
    }
    ...
    inline fun getStandardLayoutBaseWithFields(): CXXRecordDecl? {
    ...
    inline fun addedEligibleSpecialMemberFunction(MD: CXXMethodDecl?, SMKind: UInt): Unit {
        return clang_CXXRecordDecl_added_eligible_special_member_function(ptr, MD?.ptr, SMKind)
    }
    inline fun getInstantiatedFromMemberClass(): CXXRecordDecl? {
        return CXXRecordDecl((clang_CXXRecordDecl_get_instantiated_from_member_class(ptr) ?: return null), memScope)
    }
    inline fun setInstantiationOfMemberClass(RD: CXXRecordDecl?, TSK: TemplateSpecializationKind): Unit {
    ...
    inline fun getTemplateInstantiationPattern(): CXXRecordDecl? {
    ...
    inline fun isDerivedFrom(Base: CXXRecordDecl?): Boolean {
        return clang_CXXRecordDecl_is_derived_from(ptr, Base?.ptr)
    }
    inline fun isVirtuallyDerivedFrom(Base: CXXRecordDecl?): Boolean {
        return clang_CXXRecordDecl_is_virtually_derived_from(ptr, Base?.ptr)
    }
    inline fun isProvablyNotDerivedFrom(Base: CXXRecordDecl?): Boolean {
    ...
    inline fun finishedDefaultedOrDeletedMember(MD: CXXMethodDecl?): Unit {
        return clang_CXXRecordDecl_finished_defaulted_or_deleted_member(ptr, MD?.ptr)
    }
    inline fun setTrivialForCallFlags(MD: CXXMethodDecl?): Unit {
