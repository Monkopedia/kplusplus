...
import krapper.cppfrontend.internal._clang_QualType_dump
import krapper.cppfrontend.internal._clang_QualType_get_as_string
import krapper.cppfrontend.internal.clang_QualType_add_const
import krapper.cppfrontend.internal.clang_QualType_add_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_add_restrict
import krapper.cppfrontend.internal.clang_QualType_add_volatile
import krapper.cppfrontend.internal.clang_QualType_align_of
import krapper.cppfrontend.internal.clang_QualType_dump
import krapper.cppfrontend.internal.clang_QualType_get_address_space
import krapper.cppfrontend.internal.clang_QualType_get_as_opaque_ptr
import krapper.cppfrontend.internal.clang_QualType_get_atomic_unqualified_type
import krapper.cppfrontend.internal.clang_QualType_get_canonical_type
import krapper.cppfrontend.internal.clang_QualType_get_cvr_qualifiers
import krapper.cppfrontend.internal.clang_QualType_get_desugared_type
import krapper.cppfrontend.internal.clang_QualType_get_from_opaque_ptr
import krapper.cppfrontend.internal.clang_QualType_get_local_cvr_qualifiers
import krapper.cppfrontend.internal.clang_QualType_get_local_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_get_local_unqualified_type
import krapper.cppfrontend.internal.clang_QualType_get_non_l_value_expr_type
import krapper.cppfrontend.internal.clang_QualType_get_non_pack_expansion_type
import krapper.cppfrontend.internal.clang_QualType_get_non_reference_type
import krapper.cppfrontend.internal.clang_QualType_get_obj_c_lifetime
import krapper.cppfrontend.internal.clang_QualType_get_obj_cgc_attr
import krapper.cppfrontend.internal.clang_QualType_get_single_step_desugared_type
import krapper.cppfrontend.internal.clang_QualType_get_type_ptr
import krapper.cppfrontend.internal.clang_QualType_get_type_ptr_or_null
import krapper.cppfrontend.internal.clang_QualType_get_unqualified_type
import krapper.cppfrontend.internal.clang_QualType_has_address_discriminated_pointer_auth
import krapper.cppfrontend.internal.clang_QualType_has_address_space
import krapper.cppfrontend.internal.clang_QualType_has_local_non_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_has_local_qualifiers
import krapper.cppfrontend.internal.clang_QualType_has_non_trivial_obj_c_lifetime
import krapper.cppfrontend.internal.clang_QualType_has_non_trivial_to_primitive_copy_c_union
import krapper.cppfrontend.internal.clang_QualType_has_non_trivial_to_primitive_default_initialize_c_union
import krapper.cppfrontend.internal.clang_QualType_has_non_trivial_to_primitive_destruct_c_union
import krapper.cppfrontend.internal.clang_QualType_has_qualifiers
import krapper.cppfrontend.internal.clang_QualType_has_strong_or_weak_obj_c_lifetime
import krapper.cppfrontend.internal.clang_QualType_ignore_parens
import krapper.cppfrontend.internal.clang_QualType_is_address_space_overlapping
import krapper.cppfrontend.internal.clang_QualType_is_at_least_as_qualified_as
import krapper.cppfrontend.internal.clang_QualType_is_bitwise_cloneable_type
import krapper.cppfrontend.internal.clang_QualType_is_c_forbidden_l_value_type
import krapper.cppfrontend.internal.clang_QualType_is_canonical
import krapper.cppfrontend.internal.clang_QualType_is_canonical_as_param
import krapper.cppfrontend.internal.clang_QualType_is_const_qualified
import krapper.cppfrontend.internal.clang_QualType_is_constant
import krapper.cppfrontend.internal.clang_QualType_is_constant_storage
import krapper.cppfrontend.internal.clang_QualType_is_cxx11pod_type
import krapper.cppfrontend.internal.clang_QualType_is_cxx98pod_type
import krapper.cppfrontend.internal.clang_QualType_is_destructed_type
import krapper.cppfrontend.internal.clang_QualType_is_local_const_qualified
import krapper.cppfrontend.internal.clang_QualType_is_local_restrict_qualified
import krapper.cppfrontend.internal.clang_QualType_is_local_volatile_qualified
import krapper.cppfrontend.internal.clang_QualType_is_more_qualified_than
import krapper.cppfrontend.internal.clang_QualType_is_non_trivial_to_primitive_copy
import krapper.cppfrontend.internal.clang_QualType_is_non_trivial_to_primitive_default_initialize
import krapper.cppfrontend.internal.clang_QualType_is_non_trivial_to_primitive_destructive_move
import krapper.cppfrontend.internal.clang_QualType_is_non_weak_in_mrr_with_obj_c_weak
import krapper.cppfrontend.internal.clang_QualType_is_null
import krapper.cppfrontend.internal.clang_QualType_is_obj_cgc_strong
import krapper.cppfrontend.internal.clang_QualType_is_obj_cgc_weak
import krapper.cppfrontend.internal.clang_QualType_is_pod_type
import krapper.cppfrontend.internal.clang_QualType_is_referenceable
import krapper.cppfrontend.internal.clang_QualType_is_restrict_qualified
import krapper.cppfrontend.internal.clang_QualType_is_trivial_type
import krapper.cppfrontend.internal.clang_QualType_is_trivially_copy_constructible_type
import krapper.cppfrontend.internal.clang_QualType_is_trivially_copyable_type
import krapper.cppfrontend.internal.clang_QualType_is_volatile_qualified
import krapper.cppfrontend.internal.clang_QualType_is_web_assembly_externref_type
import krapper.cppfrontend.internal.clang_QualType_is_web_assembly_funcref_type
import krapper.cppfrontend.internal.clang_QualType_is_web_assembly_reference_type
import krapper.cppfrontend.internal.clang_QualType_may_be_dynamic_class
import krapper.cppfrontend.internal.clang_QualType_may_be_not_dynamic_class
import krapper.cppfrontend.internal.clang_QualType_new
import krapper.cppfrontend.internal.clang_QualType_new__const_clang_Type_P_unsigned_int
import krapper.cppfrontend.internal.clang_QualType_op_pointer_reference
import krapper.cppfrontend.internal.clang_QualType_op_reference
import krapper.cppfrontend.internal.clang_QualType_remove_local_const
import krapper.cppfrontend.internal.clang_QualType_remove_local_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_remove_local_fast_qualifiers__unsigned_int
import krapper.cppfrontend.internal.clang_QualType_remove_local_restrict
import krapper.cppfrontend.internal.clang_QualType_remove_local_volatile
import krapper.cppfrontend.internal.clang_QualType_set_local_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_size_of
import krapper.cppfrontend.internal.clang_QualType_strip_obj_c_kind_of_type
import krapper.cppfrontend.internal.clang_QualType_subst_obj_c_member_type
import krapper.cppfrontend.internal.clang_QualType_use_excess_precision
import krapper.cppfrontend.internal.clang_QualType_with_const
import krapper.cppfrontend.internal.clang_QualType_with_cvr_qualifiers
import krapper.cppfrontend.internal.clang_QualType_with_exact_local_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_with_fast_qualifiers
import krapper.cppfrontend.internal.clang_QualType_with_restrict
import krapper.cppfrontend.internal.clang_QualType_with_volatile
import krapper.cppfrontend.internal.clang_QualType_without_local_fast_qualifiers
