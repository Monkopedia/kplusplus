...
import krapper.cppfrontend.internal.clang_CXXMethodDecl_align_of
import krapper.cppfrontend.internal.clang_CXXMethodDecl_as_clang_Decl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_as_clang_DeclContext
import krapper.cppfrontend.internal.clang_CXXMethodDecl_as_clang_DeclaratorDecl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_as_clang_FunctionDecl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_as_clang_NamedDecl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_as_clang_ValueDecl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_classof
import krapper.cppfrontend.internal.clang_CXXMethodDecl_classof_kind
import krapper.cppfrontend.internal.clang_CXXMethodDecl_dyncast_clang_CXXConstructorDecl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_dyncast_clang_CXXDestructorDecl
...
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_this_type__const_clang_FunctionProtoType_P_const_clang_CXXRecordDecl_P
...
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_static_overloaded_operator
...
import krapper.cppfrontend.internal.clang_CXXMethodDecl_size_of
...
import krapper.cppfrontend.internal.clang_FunctionDecl_get_canonical_decl
...
import krapper.cppfrontend.internal.clang_FunctionDecl_is_static
...
// WARNING: polymorphic class with a non-virtual destructor — deleting a CXXMethodDecl through a base pointer is undefined in C++ (the derived destructor will not run). Give the base a `virtual ~...()` to fix.
...
class CXXMethodDecl(
    ...
    companion object {
        ...
        inline fun MemScope._getThisType(FPT: FunctionProtoType?, Decl: CXXRecordDeclApi?): QualType {
            val retValue: QualType = memScope.QualType_Holder()
            clang_CXXMethodDecl_get_this_type__const_clang_FunctionProtoType_P_const_clang_CXXRecordDecl_P(FPT?.ptr, Decl?.ptr, retValue.ptr)
            return retValue
        }
    ...
    inline fun asCXXConstructorDecl(): CXXConstructorDecl? {
        val raw: COpaquePointer = (clang_CXXMethodDecl_dyncast_clang_CXXConstructorDecl(ptr) ?: return null)
        return CXXConstructorDecl(raw, memScope)
    }
    inline fun asCXXDestructorDecl(): CXXDestructorDecl? {
        val raw: COpaquePointer = (clang_CXXMethodDecl_dyncast_clang_CXXDestructorDecl(ptr) ?: return null)
        return CXXDestructorDecl(raw, memScope)
    }
}
