...
import krapper.cppfrontend.internal._clang_CXXConstructorDecl_is_copy_constructor
import krapper.cppfrontend.internal._clang_CXXConstructorDecl_is_copy_or_move_constructor
import krapper.cppfrontend.internal._clang_CXXConstructorDecl_is_move_constructor
import krapper.cppfrontend.internal._clang_FunctionDecl_has_body
import krapper.cppfrontend.internal._clang_FunctionDecl_is_defined
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_align_of
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_CXXMethodDecl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_Decl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_DeclContext
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_DeclaratorDecl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_FunctionDecl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_NamedDecl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_as_clang_ValueDecl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_classof
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_classof_kind
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_get_canonical_decl
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_get_num_ctor_initializers
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_get_target_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_converting_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_copy_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_copy_or_move_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_default_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_delegating_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_explicit
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_inheriting_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_move_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_is_specialization_copying_object
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_set_inheriting_constructor
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_set_num_ctor_initializers
import krapper.cppfrontend.internal.clang_CXXConstructorDecl_size_of
import krapper.cppfrontend.internal.clang_CXXMethodDecl_add_overridden_method
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_canonical_decl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_corresponding_method_declared_in_class
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_corresponding_method_in_class
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_function_object_parameter_reference_type
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_function_object_parameter_type
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_most_recent_decl
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_num_explicit_params
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_parent
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_ref_qualifier
import krapper.cppfrontend.internal.clang_CXXMethodDecl_get_this_type
import krapper.cppfrontend.internal.clang_CXXMethodDecl_has_inline_body
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_const
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_copy_assignment_operator
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_explicit_object_member_function
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_implicit_object_member_function
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_instance
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_lambda_static_invoker
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_move_assignment_operator
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_static
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_virtual
import krapper.cppfrontend.internal.clang_CXXMethodDecl_is_volatile
import krapper.cppfrontend.internal.clang_CXXMethodDecl_size_overridden_methods
...
import krapper.cppfrontend.internal.clang_FunctionDecl_body_contains_immediate_escalating_expressions
import krapper.cppfrontend.internal.clang_FunctionDecl_does_declaration_force_externally_visible_definition
import krapper.cppfrontend.internal.clang_FunctionDecl_does_this_declaration_have_a_body
import krapper.cppfrontend.internal.clang_FunctionDecl_friend_constraint_refers_to_enclosing_template
import krapper.cppfrontend.internal.clang_FunctionDecl_get_builtin_id
import krapper.cppfrontend.internal.clang_FunctionDecl_get_call_result_type
import krapper.cppfrontend.internal.clang_FunctionDecl_get_constexpr_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_get_declared_return_type
import krapper.cppfrontend.internal.clang_FunctionDecl_get_definition
import krapper.cppfrontend.internal.clang_FunctionDecl_get_exception_spec_type
import krapper.cppfrontend.internal.clang_FunctionDecl_get_instantiated_from_decl
import krapper.cppfrontend.internal.clang_FunctionDecl_get_instantiated_from_member_function
import krapper.cppfrontend.internal.clang_FunctionDecl_get_language_linkage
import krapper.cppfrontend.internal.clang_FunctionDecl_get_memory_function_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_get_min_required_arguments
import krapper.cppfrontend.internal.clang_FunctionDecl_get_min_required_explicit_arguments
import krapper.cppfrontend.internal.clang_FunctionDecl_get_multi_version_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_get_non_object_parameter
import krapper.cppfrontend.internal.clang_FunctionDecl_get_num_non_object_params
import krapper.cppfrontend.internal.clang_FunctionDecl_get_num_params
import krapper.cppfrontend.internal.clang_FunctionDecl_get_odr_hash
import krapper.cppfrontend.internal.clang_FunctionDecl_get_overloaded_operator
import krapper.cppfrontend.internal.clang_FunctionDecl_get_param_decl
import krapper.cppfrontend.internal.clang_FunctionDecl_get_return_type
import krapper.cppfrontend.internal.clang_FunctionDecl_get_storage_class
import krapper.cppfrontend.internal.clang_FunctionDecl_get_template_instantiation_pattern
import krapper.cppfrontend.internal.clang_FunctionDecl_get_template_specialization_args
import krapper.cppfrontend.internal.clang_FunctionDecl_get_template_specialization_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_get_template_specialization_kind_for_instantiation
import krapper.cppfrontend.internal.clang_FunctionDecl_get_templated_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_has_body
import krapper.cppfrontend.internal.clang_FunctionDecl_has_cxx_explicit_function_object_parameter
import krapper.cppfrontend.internal.clang_FunctionDecl_has_implicit_return_zero
import krapper.cppfrontend.internal.clang_FunctionDecl_has_inherited_prototype
import krapper.cppfrontend.internal.clang_FunctionDecl_has_one_param_or_default_args
import krapper.cppfrontend.internal.clang_FunctionDecl_has_prototype
import krapper.cppfrontend.internal.clang_FunctionDecl_has_skipped_body
import krapper.cppfrontend.internal.clang_FunctionDecl_has_trivial_body
import krapper.cppfrontend.internal.clang_FunctionDecl_has_written_prototype
import krapper.cppfrontend.internal.clang_FunctionDecl_instantiation_is_pending
import krapper.cppfrontend.internal.clang_FunctionDecl_is_analyzer_no_return
import krapper.cppfrontend.internal.clang_FunctionDecl_is_consteval
import krapper.cppfrontend.internal.clang_FunctionDecl_is_constexpr
import krapper.cppfrontend.internal.clang_FunctionDecl_is_constexpr_specified
import krapper.cppfrontend.internal.clang_FunctionDecl_is_cpu_dispatch_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_is_cpu_specific_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_is_defaulted
import krapper.cppfrontend.internal.clang_FunctionDecl_is_defined
import krapper.cppfrontend.internal.clang_FunctionDecl_is_deleted
import krapper.cppfrontend.internal.clang_FunctionDecl_is_deleted_as_written
import krapper.cppfrontend.internal.clang_FunctionDecl_is_destroying_operator_delete
import krapper.cppfrontend.internal.clang_FunctionDecl_is_explicitly_defaulted
import krapper.cppfrontend.internal.clang_FunctionDecl_is_extern_c
import krapper.cppfrontend.internal.clang_FunctionDecl_is_function_template_specialization
import krapper.cppfrontend.internal.clang_FunctionDecl_is_global
import krapper.cppfrontend.internal.clang_FunctionDecl_is_immediate_escalating
import krapper.cppfrontend.internal.clang_FunctionDecl_is_immediate_function
import krapper.cppfrontend.internal.clang_FunctionDecl_is_implicitly_instantiable
import krapper.cppfrontend.internal.clang_FunctionDecl_is_in_extern_c_context
import krapper.cppfrontend.internal.clang_FunctionDecl_is_in_extern_cxx_context
import krapper.cppfrontend.internal.clang_FunctionDecl_is_ineligible_or_not_selected
import krapper.cppfrontend.internal.clang_FunctionDecl_is_inline_builtin_declaration
import krapper.cppfrontend.internal.clang_FunctionDecl_is_inline_definition_externally_visible
import krapper.cppfrontend.internal.clang_FunctionDecl_is_inline_specified
import krapper.cppfrontend.internal.clang_FunctionDecl_is_inlined
import krapper.cppfrontend.internal.clang_FunctionDecl_is_instantiated_from_member_template
import krapper.cppfrontend.internal.clang_FunctionDecl_is_late_template_parsed
import krapper.cppfrontend.internal.clang_FunctionDecl_is_main
import krapper.cppfrontend.internal.clang_FunctionDecl_is_member_like_constrained_friend
import krapper.cppfrontend.internal.clang_FunctionDecl_is_ms_extern_inline
import krapper.cppfrontend.internal.clang_FunctionDecl_is_msvcrt_entry_point
import krapper.cppfrontend.internal.clang_FunctionDecl_is_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_is_no_return
import krapper.cppfrontend.internal.clang_FunctionDecl_is_out_of_line
import krapper.cppfrontend.internal.clang_FunctionDecl_is_overloaded_operator
import krapper.cppfrontend.internal.clang_FunctionDecl_is_pure_virtual
import krapper.cppfrontend.internal.clang_FunctionDecl_is_referenceable_kernel
import krapper.cppfrontend.internal.clang_FunctionDecl_is_replaceable_global_allocation_function
import krapper.cppfrontend.internal.clang_FunctionDecl_is_reserved_global_placement_operator
import krapper.cppfrontend.internal.clang_FunctionDecl_is_target_clones_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_is_target_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_is_target_multi_version_default
import krapper.cppfrontend.internal.clang_FunctionDecl_is_target_version_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_is_template_instantiation
import krapper.cppfrontend.internal.clang_FunctionDecl_is_this_declaration_a_definition
import krapper.cppfrontend.internal.clang_FunctionDecl_is_this_declaration_instantiated_from_a_friend_definition
import krapper.cppfrontend.internal.clang_FunctionDecl_is_trivial
import krapper.cppfrontend.internal.clang_FunctionDecl_is_trivial_for_call
import krapper.cppfrontend.internal.clang_FunctionDecl_is_type_aware_operator_new_or_delete
import krapper.cppfrontend.internal.clang_FunctionDecl_is_usable_as_global_allocation_function_in_constant_evaluation
import krapper.cppfrontend.internal.clang_FunctionDecl_is_user_provided
import krapper.cppfrontend.internal.clang_FunctionDecl_is_variadic
import krapper.cppfrontend.internal.clang_FunctionDecl_is_virtual_as_written
import krapper.cppfrontend.internal.clang_FunctionDecl_param_empty
import krapper.cppfrontend.internal.clang_FunctionDecl_param_size
import krapper.cppfrontend.internal.clang_FunctionDecl_set_body_contains_immediate_escalating_expressions
import krapper.cppfrontend.internal.clang_FunctionDecl_set_constexpr_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_set_defaulted
import krapper.cppfrontend.internal.clang_FunctionDecl_set_deleted_as_written
import krapper.cppfrontend.internal.clang_FunctionDecl_set_explicitly_defaulted
import krapper.cppfrontend.internal.clang_FunctionDecl_set_friend_constraint_refers_to_enclosing_template
import krapper.cppfrontend.internal.clang_FunctionDecl_set_has_implicit_return_zero
import krapper.cppfrontend.internal.clang_FunctionDecl_set_has_inherited_prototype
import krapper.cppfrontend.internal.clang_FunctionDecl_set_has_skipped_body
import krapper.cppfrontend.internal.clang_FunctionDecl_set_has_written_prototype
import krapper.cppfrontend.internal.clang_FunctionDecl_set_implicitly_inline
import krapper.cppfrontend.internal.clang_FunctionDecl_set_ineligible_or_not_selected
import krapper.cppfrontend.internal.clang_FunctionDecl_set_inline_specified
import krapper.cppfrontend.internal.clang_FunctionDecl_set_instantiated_from_decl
import krapper.cppfrontend.internal.clang_FunctionDecl_set_instantiated_from_member_template
import krapper.cppfrontend.internal.clang_FunctionDecl_set_instantiation_is_pending
import krapper.cppfrontend.internal.clang_FunctionDecl_set_instantiation_of_member_function
import krapper.cppfrontend.internal.clang_FunctionDecl_set_is_destroying_operator_delete
import krapper.cppfrontend.internal.clang_FunctionDecl_set_is_multi_version
import krapper.cppfrontend.internal.clang_FunctionDecl_set_is_pure_virtual
import krapper.cppfrontend.internal.clang_FunctionDecl_set_is_type_aware_operator_new_or_delete
import krapper.cppfrontend.internal.clang_FunctionDecl_set_late_template_parsed
import krapper.cppfrontend.internal.clang_FunctionDecl_set_lazy_body
import krapper.cppfrontend.internal.clang_FunctionDecl_set_previous_declaration
import krapper.cppfrontend.internal.clang_FunctionDecl_set_storage_class
import krapper.cppfrontend.internal.clang_FunctionDecl_set_template_specialization_kind
import krapper.cppfrontend.internal.clang_FunctionDecl_set_trivial
import krapper.cppfrontend.internal.clang_FunctionDecl_set_trivial_for_call
import krapper.cppfrontend.internal.clang_FunctionDecl_set_uses_fp_intrin
import krapper.cppfrontend.internal.clang_FunctionDecl_set_uses_seh_try
import krapper.cppfrontend.internal.clang_FunctionDecl_set_virtual_as_written
import krapper.cppfrontend.internal.clang_FunctionDecl_set_will_have_body
import krapper.cppfrontend.internal.clang_FunctionDecl_uses_fp_intrin
import krapper.cppfrontend.internal.clang_FunctionDecl_uses_seh_try
import krapper.cppfrontend.internal.clang_FunctionDecl_will_have_body
...
import krapper.cppfrontend.internal.clang_ValueDecl_is_init_capture
...
@krapper.CppBinding("clang::CXXConstructorDecl")
class CXXConstructorDecl(
    ...
    inline fun isExplicit(): Boolean {
        return clang_CXXConstructorDecl_is_explicit(ptr)
    }
    inline fun getNumCtorInitializers(): UInt {
        return clang_CXXConstructorDecl_get_num_ctor_initializers(ptr)
    }
    inline fun setNumCtorInitializers(numCtorInitializers: UInt): Unit {
        return clang_CXXConstructorDecl_set_num_ctor_initializers(ptr, numCtorInitializers)
    }
    inline fun isDelegatingConstructor(): Boolean {
        return clang_CXXConstructorDecl_is_delegating_constructor(ptr)
    }
    inline fun getTargetConstructor(): CXXConstructorDecl? {
        return CXXConstructorDecl((clang_CXXConstructorDecl_get_target_constructor(ptr) ?: return null), memScope)
    }
    inline fun isDefaultConstructor(): Boolean {
        return clang_CXXConstructorDecl_is_default_constructor(ptr)
    }
    inline fun isCopyConstructor__unsigned_int(TypeQuals: UInt): Boolean {
        return clang_CXXConstructorDecl_is_copy_constructor(ptr, TypeQuals)
    }
    inline fun isCopyConstructor(): Boolean {
        return _clang_CXXConstructorDecl_is_copy_constructor(ptr)
    }
    inline fun isMoveConstructor__unsigned_int(TypeQuals: UInt): Boolean {
        return clang_CXXConstructorDecl_is_move_constructor(ptr, TypeQuals)
    }
    inline fun isMoveConstructor(): Boolean {
        return _clang_CXXConstructorDecl_is_move_constructor(ptr)
    }
    inline fun isCopyOrMoveConstructor__unsigned_int(TypeQuals: UInt): Boolean {
        return clang_CXXConstructorDecl_is_copy_or_move_constructor(ptr, TypeQuals)
    }
    inline fun isCopyOrMoveConstructor(): Boolean {
        return _clang_CXXConstructorDecl_is_copy_or_move_constructor(ptr)
    }
    inline fun isConvertingConstructor(AllowExplicit: Boolean): Boolean {
        return clang_CXXConstructorDecl_is_converting_constructor(ptr, AllowExplicit)
    }
    inline fun isSpecializationCopyingObject(): Boolean {
        return clang_CXXConstructorDecl_is_specialization_copying_object(ptr)
    }
    inline fun isInheritingConstructor(): Boolean {
        return clang_CXXConstructorDecl_is_inheriting_constructor(ptr)
    }
    inline fun setInheritingConstructor(isIC: Boolean = true): Unit {
        return clang_CXXConstructorDecl_set_inheriting_constructor(ptr, isIC)
    }
    inline fun cXXConstructorDeclGetCanonicalDecl(): CXXConstructorDecl? {
        return CXXConstructorDecl((clang_CXXConstructorDecl_get_canonical_decl(ptr) ?: return null), memScope)
    }
    companion object {
        val size: Int
            inline get() {
                return clang_CXXConstructorDecl_size_of()
            }

        val align: Int
            inline get() {
                return clang_CXXConstructorDecl_align_of()
            }

        inline fun MemScope.classof(D: DeclApi?): Boolean {
            return clang_CXXConstructorDecl_classof(D?.ptr)
        }
        inline fun MemScope.classofKind(K: Kind): Boolean {
            return clang_CXXConstructorDecl_classof_kind(K.value)
        }
        fun MemScope.CXXConstructorDecl_Holder(): CXXConstructorDecl {
            val memory: COpaquePointer = (interpretCPointer(alloc(size, align).rawPtr) ?: error("Allocation failed"))
            return CXXConstructorDecl(memory, this)
        }
    }
    inline fun asCXXMethodDecl(): CXXMethodDecl {
        return CXXMethodDecl(clang_CXXConstructorDecl_as_clang_CXXMethodDecl(ptr)!!, memScope)
    }
    inline fun asFunctionDecl(): FunctionDecl {
        return FunctionDecl(clang_CXXConstructorDecl_as_clang_FunctionDecl(ptr)!!, memScope)
    }
    inline fun asDeclaratorDecl(): DeclaratorDecl {
        return DeclaratorDecl(clang_CXXConstructorDecl_as_clang_DeclaratorDecl(ptr)!!, memScope)
    }
    inline fun asDeclContext(): DeclContext {
        return DeclContext(clang_CXXConstructorDecl_as_clang_DeclContext(ptr)!!, memScope)
    }
    inline fun asValueDecl(): ValueDecl {
        return ValueDecl(clang_CXXConstructorDecl_as_clang_ValueDecl(ptr)!!, memScope)
    }
    inline fun asNamedDecl(): NamedDecl {
        return NamedDecl(clang_CXXConstructorDecl_as_clang_NamedDecl(ptr)!!, memScope)
    }
    inline fun asDecl(): Decl {
        return Decl(clang_CXXConstructorDecl_as_clang_Decl(ptr)!!, memScope)
    }
}
