...
class OpAssignTest {
    ...
    @Test fun assign_copies_fields() = memScoped {
        ...
        with(Vec2) {
            ...
            val b = ms.Vec2__double_double(8.0, 9.0)
            val r = a assign b
    ...
    @Test fun plus_equals_returns_receiver_and_chains() = memScoped {
        ...
        with(Vec2) {
            ...
            val c = ms.Vec2__double_double(1.0, 1.0)
            val d = ms.Vec2__double_double(2.0, 2.0)
    ...
    @Test fun assign_returns_receiver_and_chains() = memScoped {
        ...
        with(Vec2) {
            val a = ms.Vec2__double_double(1.0, 2.0)
            val b = ms.Vec2__double_double(5.0, 6.0)
            val c = ms.Vec2__double_double(0.0, 0.0)
    ...
    @Test fun minus_equals_mutates_in_place() = memScoped {
        val ms = this
        with(Vec2) {
            val a = ms.Vec2__double_double(10.0, 8.0)
            val b = ms.Vec2__double_double(3.0, 2.0)
    ...
    @Test fun div_equals_scales_in_place() = memScoped {
        val ms = this
        with(Vec2) {
            val a = ms.Vec2__double_double(8.0, 6.0)
    ...
    @Test fun mod_equals_reduces_in_place() = memScoped {
        val ms = this
        with(Vec2) {
            val a = ms.Vec2__double_double(17.0, 10.0)
    ...
    @Test fun compound_assigns_are_distinct() = memScoped {
        val ms = this
        with(Vec2) {
            val a = ms.Vec2__double_double(12.0, 9.0)
            val b = ms.Vec2__double_double(2.0, 3.0)
