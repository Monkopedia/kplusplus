...
import clang.InClassInitStyle.Companion.fromValue as InClassInitStyleCompanionfromValue
...
import krapper.krapper_parse.internal.clang_FieldDecl_align_of
import krapper.krapper_parse.internal.clang_FieldDecl_as_clang_Decl
import krapper.krapper_parse.internal.clang_FieldDecl_as_clang_DeclaratorDecl
import krapper.krapper_parse.internal.clang_FieldDecl_as_clang_NamedDecl
import krapper.krapper_parse.internal.clang_FieldDecl_as_clang_ValueDecl
import krapper.krapper_parse.internal.clang_FieldDecl_classof
import krapper.krapper_parse.internal.clang_FieldDecl_classof_kind
import krapper.krapper_parse.internal.clang_FieldDecl_find_counted_by_field
import krapper.krapper_parse.internal.clang_FieldDecl_get_bit_width_value
import krapper.krapper_parse.internal.clang_FieldDecl_get_canonical_decl
import krapper.krapper_parse.internal.clang_FieldDecl_get_field_index
import krapper.krapper_parse.internal.clang_FieldDecl_get_in_class_init_style
import krapper.krapper_parse.internal.clang_FieldDecl_get_parent
import krapper.krapper_parse.internal.clang_FieldDecl_has_captured_vla_type
import krapper.krapper_parse.internal.clang_FieldDecl_has_constant_integer_bit_width
import krapper.krapper_parse.internal.clang_FieldDecl_has_in_class_initializer
import krapper.krapper_parse.internal.clang_FieldDecl_has_non_null_in_class_initializer
import krapper.krapper_parse.internal.clang_FieldDecl_is_anonymous_struct_or_union
import krapper.krapper_parse.internal.clang_FieldDecl_is_bit_field
import krapper.krapper_parse.internal.clang_FieldDecl_is_mutable
import krapper.krapper_parse.internal.clang_FieldDecl_is_potentially_overlapping
import krapper.krapper_parse.internal.clang_FieldDecl_is_unnamed_bit_field
import krapper.krapper_parse.internal.clang_FieldDecl_is_zero_length_bit_field
import krapper.krapper_parse.internal.clang_FieldDecl_is_zero_size
import krapper.krapper_parse.internal.clang_FieldDecl_remove_bit_width
import krapper.krapper_parse.internal.clang_FieldDecl_remove_in_class_initializer
import krapper.krapper_parse.internal.clang_FieldDecl_size_of
...
@krapper.CppBinding("clang::FieldDecl")
class FieldDecl(
    override val ptr: COpaquePointer,
    val memScope: MemScope,
) : clang.DeclaratorDeclApi, clang.ValueDeclApi, clang.NamedDeclApi, clang.DeclApi {
    ...
    inline fun getFieldIndex(): UInt {
        return clang_FieldDecl_get_field_index(ptr)
    }
    inline fun isMutable(): Boolean {
        return clang_FieldDecl_is_mutable(ptr)
    }
    inline fun isBitField(): Boolean {
        return clang_FieldDecl_is_bit_field(ptr)
    }
    inline fun isUnnamedBitField(): Boolean {
        return clang_FieldDecl_is_unnamed_bit_field(ptr)
    }
    inline fun isAnonymousStructOrUnion(): Boolean {
        return clang_FieldDecl_is_anonymous_struct_or_union(ptr)
    }
    inline fun hasConstantIntegerBitWidth(): Boolean {
        return clang_FieldDecl_has_constant_integer_bit_width(ptr)
    }
    inline fun getBitWidthValue(): UInt {
        return clang_FieldDecl_get_bit_width_value(ptr)
    }
    inline fun removeBitWidth(): Unit {
        return clang_FieldDecl_remove_bit_width(ptr)
    }
    inline fun isZeroLengthBitField(): Boolean {
        return clang_FieldDecl_is_zero_length_bit_field(ptr)
    }
    inline fun isZeroSize(Ctx: ASTContext): Boolean {
        return clang_FieldDecl_is_zero_size(ptr, Ctx.ptr)
    }
    inline fun isPotentiallyOverlapping(): Boolean {
        return clang_FieldDecl_is_potentially_overlapping(ptr)
    }
    inline fun getInClassInitStyle(): InClassInitStyle {
        return InClassInitStyleCompanionfromValue(clang_FieldDecl_get_in_class_init_style(ptr))
    }
    inline fun hasInClassInitializer(): Boolean {
        return clang_FieldDecl_has_in_class_initializer(ptr)
    }
    inline fun hasNonNullInClassInitializer(): Boolean {
        return clang_FieldDecl_has_non_null_in_class_initializer(ptr)
    }
    inline fun findCountedByField(): FieldDecl? {
        return FieldDecl((clang_FieldDecl_find_counted_by_field(ptr) ?: return null), memScope)
    }
    inline fun removeInClassInitializer(): Unit {
        return clang_FieldDecl_remove_in_class_initializer(ptr)
    }
    inline fun hasCapturedVLAType(): Boolean {
        return clang_FieldDecl_has_captured_vla_type(ptr)
    }
    inline fun getParent(): RecordDeclApi? {
        return RecordDecl((clang_FieldDecl_get_parent(ptr) ?: return null), memScope)
    }
    inline fun fieldDeclGetCanonicalDecl(): FieldDecl? {
        return FieldDecl((clang_FieldDecl_get_canonical_decl(ptr) ?: return null), memScope)
    }
    companion object {
        val size: Int
            inline get() {
                return clang_FieldDecl_size_of()
            }

        val align: Int
            inline get() {
                return clang_FieldDecl_align_of()
            }

        inline fun MemScope.classof(D: DeclApi?): Boolean {
            return clang_FieldDecl_classof(D?.ptr)
        }
        inline fun MemScope.classofKind(K: Kind): Boolean {
            return clang_FieldDecl_classof_kind(K.value)
        }
        fun MemScope.FieldDecl_Holder(): FieldDecl {
            val memory: COpaquePointer = (interpretCPointer(alloc(size, align).rawPtr) ?: error("Allocation failed"))
            return FieldDecl(memory, this)
        }
    }
    inline fun asDeclaratorDecl(): DeclaratorDecl {
        return DeclaratorDecl(clang_FieldDecl_as_clang_DeclaratorDecl(ptr)!!, memScope)
    }
    inline fun asValueDecl(): ValueDecl {
        return ValueDecl(clang_FieldDecl_as_clang_ValueDecl(ptr)!!, memScope)
    }
    inline fun asNamedDecl(): NamedDecl {
        return NamedDecl(clang_FieldDecl_as_clang_NamedDecl(ptr)!!, memScope)
    }
    inline fun asDecl(): Decl {
        return Decl(clang_FieldDecl_as_clang_Decl(ptr)!!, memScope)
    }
}
