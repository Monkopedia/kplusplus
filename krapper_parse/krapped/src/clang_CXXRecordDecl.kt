...
import clang.LambdaCaptureDefault.Companion.fromValue as LambdaCaptureDefaultCompanionfromValue
...
import clang.RecordArgPassingKind.Companion.fromValue
import clang.TagTypeKind.Companion.fromValue as CompanionfromValue
...
import krapper.krapper_parse.internal.clang_CXXRecordDecl_added_eligible_special_member_function
import krapper.krapper_parse.internal.clang_CXXRecordDecl_added_selected_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_align_of
import krapper.krapper_parse.internal.clang_CXXRecordDecl_allow_const_default_init
import krapper.krapper_parse.internal.clang_CXXRecordDecl_as_clang_Decl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_as_clang_DeclContext
import krapper.krapper_parse.internal.clang_CXXRecordDecl_as_clang_NamedDecl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_as_clang_RecordDecl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_as_clang_TagDecl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_as_clang_TypeDecl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_bases
import krapper.krapper_parse.internal.clang_CXXRecordDecl_calculate_inheritance_model
import krapper.krapper_parse.internal.clang_CXXRecordDecl_capture_size
import krapper.krapper_parse.internal.clang_CXXRecordDecl_classof
import krapper.krapper_parse.internal.clang_CXXRecordDecl_classof_kind
import krapper.krapper_parse.internal.clang_CXXRecordDecl_complete_definition
import krapper.krapper_parse.internal.clang_CXXRecordDecl_defaulted_copy_constructor_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_defaulted_default_constructor_is_constexpr
import krapper.krapper_parse.internal.clang_CXXRecordDecl_defaulted_destructor_is_constexpr
import krapper.krapper_parse.internal.clang_CXXRecordDecl_defaulted_destructor_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_defaulted_move_constructor_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_dyncast_clang_ClassTemplateSpecializationDecl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_finished_defaulted_or_deleted_member
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_canonical_decl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_definition
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_definition_or_self
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_described_class_template
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_device_lambda_mangling_number
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_generic_lambda_template_parameter_list
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_instantiated_from_member_class
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_call_operator
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_capture_default
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_context_decl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_dependency_kind
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_index_in_context
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_mangling_number
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_static_invoker
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_lambda_static_invoker__clang_CallingConv
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_most_recent_decl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_ms_inheritance_model
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_num_bases
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_num_v_bases
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_odr_hash
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_previous_decl
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_standard_layout_base_with_fields
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_template_instantiation_pattern
import krapper.krapper_parse.internal.clang_CXXRecordDecl_get_template_specialization_kind
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_any_dependent_bases
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_constexpr_default_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_constexpr_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_constexpr_non_copy_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_copy_assignment_with_const_param
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_copy_constructor_with_const_param
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_default_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_definition
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_deleted_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_direct_fields
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_friends
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_in_class_initializer
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_inherited_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_inherited_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_init_method
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_injected_class_type
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_irrelevant_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_known_lambda_internal_linkage
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_mutable_fields
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_literal_type_fields_or_bases
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_copy_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_copy_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_copy_constructor_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_default_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_destructor_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_non_trivial_move_constructor_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_private_fields
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_protected_fields
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_simple_copy_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_simple_copy_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_simple_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_simple_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_simple_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_copy_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_copy_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_copy_constructor_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_default_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_destructor_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_trivial_move_constructor_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_uninitialized_reference_member
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_copy_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_copy_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_declared_move_operation
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_user_provided_default_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_has_variant_members
import krapper.krapper_parse.internal.clang_CXXRecordDecl_implicit_copy_assignment_has_const_param
import krapper.krapper_parse.internal.clang_CXXRecordDecl_implicit_copy_constructor_has_const_param
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_abstract
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_aggregate
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_any_destructor_no_return
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_c_like
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_captureless_lambda
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_current_instantiation
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_cxx11standard_layout
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_dependent_lambda
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_derived_from
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_dynamic_class
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_effectively_final
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_empty
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_generic_lambda
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_hlsl_intangible
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_injected_class_name
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_interface_like
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_lambda
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_literal
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_local_class
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_never_dependent_lambda
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_parsing_base_specifiers
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_pod
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_polymorphic
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_provably_not_derived_from
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_standard_layout
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_structural
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_trivial
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_trivially_copy_constructible
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_trivially_copyable
import krapper.krapper_parse.internal.clang_CXXRecordDecl_is_virtually_derived_from
import krapper.krapper_parse.internal.clang_CXXRecordDecl_lambda_is_default_constructible_and_assignable
import krapper.krapper_parse.internal.clang_CXXRecordDecl_mark_abstract
import krapper.krapper_parse.internal.clang_CXXRecordDecl_may_be_abstract
import krapper.krapper_parse.internal.clang_CXXRecordDecl_may_be_dynamic_class
import krapper.krapper_parse.internal.clang_CXXRecordDecl_may_be_non_dynamic_class
import krapper.krapper_parse.internal.clang_CXXRecordDecl_merge_access
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_implicit_copy_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_implicit_copy_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_implicit_default_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_implicit_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_implicit_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_implicit_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_overload_resolution_for_copy_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_overload_resolution_for_copy_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_overload_resolution_for_destructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_overload_resolution_for_move_assignment
import krapper.krapper_parse.internal.clang_CXXRecordDecl_needs_overload_resolution_for_move_constructor
import krapper.krapper_parse.internal.clang_CXXRecordDecl_null_field_offset_is_zero
import krapper.krapper_parse.internal.clang_CXXRecordDecl_remove_conversion
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_described_class_template
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_has_trivial_special_member_for_call
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_implicit_copy_assignment_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_implicit_copy_constructor_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_implicit_destructor_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_implicit_move_assignment_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_implicit_move_constructor_is_deleted
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_init_method
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_instantiation_of_member_class
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_is_parsing_base_specifiers
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_lambda_dependency_kind
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_lambda_is_generic
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_template_specialization_kind
import krapper.krapper_parse.internal.clang_CXXRecordDecl_set_trivial_for_call_flags
import krapper.krapper_parse.internal.clang_CXXRecordDecl_size_of
import krapper.krapper_parse.internal.clang_CXXRecordDecl_vbases
import krapper.krapper_parse.internal.clang_CXXRecordDecl_view_inheritance
...
import krapper.krapper_parse.internal.clang_Decl_has_body
...
import krapper.krapper_parse.internal.clang_Decl_is_out_of_line
import krapper.krapper_parse.internal.clang_Decl_is_parameter_pack
...
import krapper.krapper_parse.internal.clang_RecordDecl_can_pass_in_registers
import krapper.krapper_parse.internal.clang_RecordDecl_field_empty
import krapper.krapper_parse.internal.clang_RecordDecl_find_first_named_data_member
import krapper.krapper_parse.internal.clang_RecordDecl_get_arg_passing_restrictions
import krapper.krapper_parse.internal.clang_RecordDecl_get_definition
import krapper.krapper_parse.internal.clang_RecordDecl_get_definition_or_self
import krapper.krapper_parse.internal.clang_RecordDecl_get_most_recent_decl
import krapper.krapper_parse.internal.clang_RecordDecl_get_num_fields
import krapper.krapper_parse.internal.clang_RecordDecl_get_odr_hash
import krapper.krapper_parse.internal.clang_RecordDecl_get_previous_decl
import krapper.krapper_parse.internal.clang_RecordDecl_has_flexible_array_member
import krapper.krapper_parse.internal.clang_RecordDecl_has_loaded_fields_from_external_storage
import krapper.krapper_parse.internal.clang_RecordDecl_has_non_trivial_to_primitive_copy_c_union
import krapper.krapper_parse.internal.clang_RecordDecl_has_non_trivial_to_primitive_default_initialize_c_union
import krapper.krapper_parse.internal.clang_RecordDecl_has_non_trivial_to_primitive_destruct_c_union
import krapper.krapper_parse.internal.clang_RecordDecl_has_object_member
import krapper.krapper_parse.internal.clang_RecordDecl_has_uninitialized_explicit_init_fields
import krapper.krapper_parse.internal.clang_RecordDecl_has_volatile_member
import krapper.krapper_parse.internal.clang_RecordDecl_is_anonymous_struct_or_union
import krapper.krapper_parse.internal.clang_RecordDecl_is_captured_record
import krapper.krapper_parse.internal.clang_RecordDecl_is_lambda
import krapper.krapper_parse.internal.clang_RecordDecl_is_ms_struct
import krapper.krapper_parse.internal.clang_RecordDecl_is_non_trivial_to_primitive_copy
import krapper.krapper_parse.internal.clang_RecordDecl_is_non_trivial_to_primitive_default_initialize
import krapper.krapper_parse.internal.clang_RecordDecl_is_non_trivial_to_primitive_destroy
import krapper.krapper_parse.internal.clang_RecordDecl_is_or_contains_union
import krapper.krapper_parse.internal.clang_RecordDecl_is_param_destroyed_in_callee
import krapper.krapper_parse.internal.clang_RecordDecl_is_randomized
import krapper.krapper_parse.internal.clang_RecordDecl_may_insert_extra_padding
import krapper.krapper_parse.internal.clang_RecordDecl_noload_field_empty
import krapper.krapper_parse.internal.clang_RecordDecl_set_anonymous_struct_or_union
import krapper.krapper_parse.internal.clang_RecordDecl_set_arg_passing_restrictions
import krapper.krapper_parse.internal.clang_RecordDecl_set_captured_record
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_flexible_array_member
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_loaded_fields_from_external_storage
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_non_trivial_to_primitive_copy_c_union
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_non_trivial_to_primitive_default_initialize_c_union
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_non_trivial_to_primitive_destruct_c_union
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_object_member
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_uninitialized_explicit_init_fields
import krapper.krapper_parse.internal.clang_RecordDecl_set_has_volatile_member
import krapper.krapper_parse.internal.clang_RecordDecl_set_is_randomized
import krapper.krapper_parse.internal.clang_RecordDecl_set_non_trivial_to_primitive_copy
import krapper.krapper_parse.internal.clang_RecordDecl_set_non_trivial_to_primitive_default_initialize
import krapper.krapper_parse.internal.clang_RecordDecl_set_non_trivial_to_primitive_destroy
import krapper.krapper_parse.internal.clang_RecordDecl_set_param_destroyed_in_callee
import krapper.krapper_parse.internal.clang_TagDecl_demote_this_definition_to_declaration
import krapper.krapper_parse.internal.clang_TagDecl_get_canonical_decl
import krapper.krapper_parse.internal.clang_TagDecl_get_kind_name
import krapper.krapper_parse.internal.clang_TagDecl_get_num_template_parameter_lists
import krapper.krapper_parse.internal.clang_TagDecl_get_tag_kind
import krapper.krapper_parse.internal.clang_TagDecl_get_template_parameter_list
import krapper.krapper_parse.internal.clang_TagDecl_get_typedef_name_for_anon_decl
import krapper.krapper_parse.internal.clang_TagDecl_has_name_for_linkage
import krapper.krapper_parse.internal.clang_TagDecl_is_being_defined
import krapper.krapper_parse.internal.clang_TagDecl_is_class
import krapper.krapper_parse.internal.clang_TagDecl_is_complete_definition
import krapper.krapper_parse.internal.clang_TagDecl_is_complete_definition_required
import krapper.krapper_parse.internal.clang_TagDecl_is_dependent_type
import krapper.krapper_parse.internal.clang_TagDecl_is_embedded_in_declarator
import krapper.krapper_parse.internal.clang_TagDecl_is_entity_being_defined
import krapper.krapper_parse.internal.clang_TagDecl_is_enum
import krapper.krapper_parse.internal.clang_TagDecl_is_free_standing
import krapper.krapper_parse.internal.clang_TagDecl_is_interface
import krapper.krapper_parse.internal.clang_TagDecl_is_struct
import krapper.krapper_parse.internal.clang_TagDecl_is_structure_or_class
import krapper.krapper_parse.internal.clang_TagDecl_is_this_declaration_a_definition
import krapper.krapper_parse.internal.clang_TagDecl_is_this_declaration_a_demoted_definition
import krapper.krapper_parse.internal.clang_TagDecl_is_union
import krapper.krapper_parse.internal.clang_TagDecl_set_complete_definition
import krapper.krapper_parse.internal.clang_TagDecl_set_complete_definition_required
import krapper.krapper_parse.internal.clang_TagDecl_set_embedded_in_declarator
import krapper.krapper_parse.internal.clang_TagDecl_set_free_standing
import krapper.krapper_parse.internal.clang_TagDecl_set_tag_kind
import krapper.krapper_parse.internal.clang_TagDecl_set_typedef_name_for_anon_decl
import krapper.krapper_parse.internal.clang_TagDecl_start_definition
import krapper.krapper_parse.internal.clang_TypeDecl_get_type_for_decl
import krapper.krapper_parse.internal.clang_TypeDecl_set_type_for_decl
...
// WARNING: polymorphic class with a non-virtual destructor — deleting a CXXRecordDecl through a base pointer is undefined in C++ (the derived destructor will not run). Give the base a `virtual ~...()` to fix.

@krapper.CppBinding("clang::CXXRecordDecl")
class CXXRecordDecl(
    ...
    inline fun getArgPassingRestrictions(): RecordArgPassingKind {
        return fromValue(clang_RecordDecl_get_arg_passing_restrictions(ptr))
    }
    ...
    inline fun getTagKind(): TagTypeKind {
        return CompanionfromValue(clang_TagDecl_get_tag_kind(ptr))
    }
    ...
    inline fun getLambdaCaptureDefault(): LambdaCaptureDefault {
        return LambdaCaptureDefaultCompanionfromValue(clang_CXXRecordDecl_get_lambda_capture_default(ptr))
    }
    ...
    inline fun getTemplateSpecializationKind(): TemplateSpecializationKind {
        return TemplateSpecializationKindCompanionfromValue(clang_CXXRecordDecl_get_template_specialization_kind(ptr))
    }
    ...
    companion object {
        val size: Int
            inline get() {
                return clang_CXXRecordDecl_size_of()
            }

        val align: Int
            inline get() {
                return clang_CXXRecordDecl_align_of()
            }

        inline fun MemScope.MergeAccess(PathAccess: AccessSpecifier, DeclAccess: AccessSpecifier): AccessSpecifier {
            return AccessSpecifierCompanionfromValue(clang_CXXRecordDecl_merge_access(PathAccess.value, DeclAccess.value))
        }
        inline fun MemScope.classof(D: DeclApi?): Boolean {
            return clang_CXXRecordDecl_classof(D?.ptr)
        }
        inline fun MemScope.classofKind(K: Kind): Boolean {
            return clang_CXXRecordDecl_classof_kind(K.value)
        }
        fun MemScope.CXXRecordDecl_Holder(): CXXRecordDecl {
            val memory: COpaquePointer = (interpretCPointer(alloc(size, align).rawPtr) ?: error("Allocation failed"))
            return CXXRecordDecl(memory, this)
        }
    }
    inline fun asRecordDecl(): RecordDecl {
        return RecordDecl(clang_CXXRecordDecl_as_clang_RecordDecl(ptr)!!, memScope)
    }
    inline fun asTagDecl(): TagDecl {
        return TagDecl(clang_CXXRecordDecl_as_clang_TagDecl(ptr)!!, memScope)
    }
    inline fun asTypeDecl(): TypeDecl {
        return TypeDecl(clang_CXXRecordDecl_as_clang_TypeDecl(ptr)!!, memScope)
    }
    inline fun asDeclContext(): DeclContext {
        return DeclContext(clang_CXXRecordDecl_as_clang_DeclContext(ptr)!!, memScope)
    }
    inline fun asNamedDecl(): NamedDecl {
        return NamedDecl(clang_CXXRecordDecl_as_clang_NamedDecl(ptr)!!, memScope)
    }
    inline fun asDecl(): Decl {
        return Decl(clang_CXXRecordDecl_as_clang_Decl(ptr)!!, memScope)
    }
    inline fun asClassTemplateSpecializationDecl(): ClassTemplateSpecializationDecl? {
        val raw: COpaquePointer = (clang_CXXRecordDecl_dyncast_clang_ClassTemplateSpecializationDecl(ptr) ?: return null)
        return ClassTemplateSpecializationDecl(raw, memScope)
    }
}
