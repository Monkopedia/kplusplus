...
import clang.aSTContext.InlineVariableDefinitionKind
import clang.aSTContext.InlineVariableDefinitionKind.Companion.fromValue as InlineVariableDefinitionKindCompanionfromValue
import clang.aSTContext.OperatorDeleteKind
...
import krapper.krapper_parse.internal.clang_ASTContext_AutoDeductTy_get
import krapper.krapper_parse.internal.clang_ASTContext_AutoDeductTy_set
import krapper.krapper_parse.internal.clang_ASTContext_AutoRRefDeductTy_get
import krapper.krapper_parse.internal.clang_ASTContext_AutoRRefDeductTy_set
import krapper.krapper_parse.internal.clang_ASTContext_CommentsLoaded_get
import krapper.krapper_parse.internal.clang_ASTContext_CommentsLoaded_set
import krapper.krapper_parse.internal.clang_ASTContext_MSGuidTagDecl_get
import krapper.krapper_parse.internal.clang_ASTContext_MSGuidTagDecl_set
import krapper.krapper_parse.internal.clang_ASTContext_MSTypeInfoTagDecl_get
import krapper.krapper_parse.internal.clang_ASTContext_MSTypeInfoTagDecl_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyAssignmentOperatorsDeclared_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyAssignmentOperatorsDeclared_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyAssignmentOperators_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyAssignmentOperators_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyConstructorsDeclared_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyConstructorsDeclared_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyConstructors_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitCopyConstructors_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDefaultConstructorsDeclared_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDefaultConstructorsDeclared_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDefaultConstructors_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDefaultConstructors_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDestructorsDeclared_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDestructorsDeclared_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDestructors_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitDestructors_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveAssignmentOperatorsDeclared_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveAssignmentOperatorsDeclared_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveAssignmentOperators_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveAssignmentOperators_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveConstructorsDeclared_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveConstructorsDeclared_set
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveConstructors_get
import krapper.krapper_parse.internal.clang_ASTContext_NumImplicitMoveConstructors_set
import krapper.krapper_parse.internal.clang_ASTContext_TUKind_get
import krapper.krapper_parse.internal.clang_ASTContext_VaListTagDecl_get
import krapper.krapper_parse.internal.clang_ASTContext_VaListTagDecl_set
import krapper.krapper_parse.internal.clang_ASTContext_add_copy_constructor_for_exception_object
import krapper.krapper_parse.internal.clang_ASTContext_add_declarator_for_unnamed_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_add_operator_delete_for_v_dtor
import krapper.krapper_parse.internal.clang_ASTContext_add_overridden_method
import krapper.krapper_parse.internal.clang_ASTContext_add_translation_unit_decl
import krapper.krapper_parse.internal.clang_ASTContext_add_typedef_name_for_unnamed_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_address_space_map_mangling_for
import krapper.krapper_parse.internal.clang_ASTContext_adjust_deduced_function_result_type
import krapper.krapper_parse.internal.clang_ASTContext_adjust_function_result_type
import krapper.krapper_parse.internal.clang_ASTContext_adjust_string_literal_base_type
import krapper.krapper_parse.internal.clang_ASTContext_align_of
import krapper.krapper_parse.internal.clang_ASTContext_allocate
import krapper.krapper_parse.internal.clang_ASTContext_any_obj_c_implementation
import krapper.krapper_parse.internal.clang_ASTContext_are_comparable_obj_c_pointer_types
import krapper.krapper_parse.internal.clang_ASTContext_are_compatible_rvv_types
import krapper.krapper_parse.internal.clang_ASTContext_are_compatible_vector_types
import krapper.krapper_parse.internal.clang_ASTContext_are_lax_compatible_rvv_types
import krapper.krapper_parse.internal.clang_ASTContext_backup_str
import krapper.krapper_parse.internal.clang_ASTContext_base_for_v_table_authentication
import krapper.krapper_parse.internal.clang_ASTContext_block_requires_copying
import krapper.krapper_parse.internal.clang_ASTContext_build_implicit_record
import krapper.krapper_parse.internal.clang_ASTContext_can_bind_obj_c_object_type
import krapper.krapper_parse.internal.clang_ASTContext_can_builtin_be_redeclared
import krapper.krapper_parse.internal.clang_ASTContext_class_needs_vector_deleting_destructor
import krapper.krapper_parse.internal.clang_ASTContext_cleanup
import krapper.krapper_parse.internal.clang_ASTContext_compute_best_enum_types
import krapper.krapper_parse.internal.clang_ASTContext_contains_address_discriminated_pointer_auth
import krapper.krapper_parse.internal.clang_ASTContext_contains_non_relocatable_pointer_auth
import krapper.krapper_parse.internal.clang_ASTContext_deallocate
import krapper.krapper_parse.internal.clang_ASTContext_decl_must_be_emitted
import krapper.krapper_parse.internal.clang_ASTContext_decode_type_str
import krapper.krapper_parse.internal.clang_ASTContext_deduplicate_merged_definitions_for
import krapper.krapper_parse.internal.clang_ASTContext_defaults_to_ms_struct
import krapper.krapper_parse.internal.clang_ASTContext_dispose
import krapper.krapper_parse.internal.clang_ASTContext_dtor_has_operator_delete
import krapper.krapper_parse.internal.clang_ASTContext_erase_decl_attrs
import krapper.krapper_parse.internal.clang_ASTContext_get_addr_space_qual_type
import krapper.krapper_parse.internal.clang_ASTContext_get_adjusted_parameter_type
import krapper.krapper_parse.internal.clang_ASTContext_get_adjusted_type
import krapper.krapper_parse.internal.clang_ASTContext_get_align_of_global_var
import krapper.krapper_parse.internal.clang_ASTContext_get_array_decayed_type
import krapper.krapper_parse.internal.clang_ASTContext_get_array_parameter_type
import krapper.krapper_parse.internal.clang_ASTContext_get_as_array_type
import krapper.krapper_parse.internal.clang_ASTContext_get_as_constant_array_type
import krapper.krapper_parse.internal.clang_ASTContext_get_ast_allocated_memory
import krapper.krapper_parse.internal.clang_ASTContext_get_atomic_type
import krapper.krapper_parse.internal.clang_ASTContext_get_attributed_type
import krapper.krapper_parse.internal.clang_ASTContext_get_attributed_type__clang_NullabilityKind_clang_QualType_clang_QualType
import krapper.krapper_parse.internal.clang_ASTContext_get_auto_deduct_type
import krapper.krapper_parse.internal.clang_ASTContext_get_auto_r_ref_deduct_type
import krapper.krapper_parse.internal.clang_ASTContext_get_auto_type
import krapper.krapper_parse.internal.clang_ASTContext_get_base_element_type
import krapper.krapper_parse.internal.clang_ASTContext_get_base_element_type__clang_QualType
import krapper.krapper_parse.internal.clang_ASTContext_get_bit_int_type
import krapper.krapper_parse.internal.clang_ASTContext_get_block_descriptor_extended_type
import krapper.krapper_parse.internal.clang_ASTContext_get_block_descriptor_type
import krapper.krapper_parse.internal.clang_ASTContext_get_block_pointer_type
import krapper.krapper_parse.internal.clang_ASTContext_get_bool_type
import krapper.krapper_parse.internal.clang_ASTContext_get_builtin_ms_va_list_type
import krapper.krapper_parse.internal.clang_ASTContext_get_builtin_type
import krapper.krapper_parse.internal.clang_ASTContext_get_builtin_va_list_type
import krapper.krapper_parse.internal.clang_ASTContext_get_byref_lifetime
import krapper.krapper_parse.internal.clang_ASTContext_get_canonical_template_argument
import krapper.krapper_parse.internal.clang_ASTContext_get_canonical_type
import krapper.krapper_parse.internal.clang_ASTContext_get_cf_constant_string_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_cf_constant_string_type
import krapper.krapper_parse.internal.clang_ASTContext_get_char_width
import krapper.krapper_parse.internal.clang_ASTContext_get_common_sugared_type
import krapper.krapper_parse.internal.clang_ASTContext_get_complex_type
import krapper.krapper_parse.internal.clang_ASTContext_get_const_type
import krapper.krapper_parse.internal.clang_ASTContext_get_constant_array_element_count
import krapper.krapper_parse.internal.clang_ASTContext_get_constant_matrix_type
import krapper.krapper_parse.internal.clang_ASTContext_get_copy_constructor_for_exception_object
import krapper.krapper_parse.internal.clang_ASTContext_get_corresponding_saturated_type
import krapper.krapper_parse.internal.clang_ASTContext_get_corresponding_signed_fixed_point_type
import krapper.krapper_parse.internal.clang_ASTContext_get_corresponding_signed_type
import krapper.krapper_parse.internal.clang_ASTContext_get_corresponding_unsaturated_type
import krapper.krapper_parse.internal.clang_ASTContext_get_corresponding_unsigned_type
import krapper.krapper_parse.internal.clang_ASTContext_get_cuid_hash
import krapper.krapper_parse.internal.clang_ASTContext_get_current_key_function
import krapper.krapper_parse.internal.clang_ASTContext_get_cvr_qualified_type
import krapper.krapper_parse.internal.clang_ASTContext_get_cxxabi_kind
import krapper.krapper_parse.internal.clang_ASTContext_get_decayed_type
import krapper.krapper_parse.internal.clang_ASTContext_get_decayed_type__clang_QualType_clang_QualType
import krapper.krapper_parse.internal.clang_ASTContext_get_declarator_for_unnamed_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_default_calling_convention
import krapper.krapper_parse.internal.clang_ASTContext_get_default_open_cl_pointee_addr_space
import krapper.krapper_parse.internal.clang_ASTContext_get_exception_object_type
import krapper.krapper_parse.internal.clang_ASTContext_get_ext_vector_type
import krapper.krapper_parse.internal.clang_ASTContext_get_field_offset
import krapper.krapper_parse.internal.clang_ASTContext_get_file_type
import krapper.krapper_parse.internal.clang_ASTContext_get_fixed_point_i_bits
import krapper.krapper_parse.internal.clang_ASTContext_get_fixed_point_scale
import krapper.krapper_parse.internal.clang_ASTContext_get_floating_type_order
import krapper.krapper_parse.internal.clang_ASTContext_get_floating_type_semantic_order
import krapper.krapper_parse.internal.clang_ASTContext_get_function_no_proto_type__clang_QualType
import krapper.krapper_parse.internal.clang_ASTContext_get_function_type_without_param_ab_is
import krapper.krapper_parse.internal.clang_ASTContext_get_function_type_without_ptr_sizes
import krapper.krapper_parse.internal.clang_ASTContext_get_gva_linkage_for_function
import krapper.krapper_parse.internal.clang_ASTContext_get_gva_linkage_for_variable
import krapper.krapper_parse.internal.clang_ASTContext_get_higher_precision_fp_type
import krapper.krapper_parse.internal.clang_ASTContext_get_incomplete_array_type
import krapper.krapper_parse.internal.clang_ASTContext_get_injected_template_arg
import krapper.krapper_parse.internal.clang_ASTContext_get_inline_variable_definition_kind
import krapper.krapper_parse.internal.clang_ASTContext_get_inner_obj_c_ownership
import krapper.krapper_parse.internal.clang_ASTContext_get_instantiated_from_unnamed_field_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_instantiated_from_using_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_int_ptr_type
import krapper.krapper_parse.internal.clang_ASTContext_get_int_type_for_bitwidth
import krapper.krapper_parse.internal.clang_ASTContext_get_int_width
import krapper.krapper_parse.internal.clang_ASTContext_get_integer_type_order
import krapper.krapper_parse.internal.clang_ASTContext_get_l_value_reference_type
import krapper.krapper_parse.internal.clang_ASTContext_get_lang_as_for_builtin_address_space
import krapper.krapper_parse.internal.clang_ASTContext_get_legacy_integral_type_encoding
import krapper.krapper_parse.internal.clang_ASTContext_get_lifetime_qualified_type
import krapper.krapper_parse.internal.clang_ASTContext_get_mangling_number
import krapper.krapper_parse.internal.clang_ASTContext_get_min_global_align_of_var
import krapper.krapper_parse.internal.clang_ASTContext_get_ms_guid_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_ms_type_info_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_next_string_literal_version
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_class_redefinition_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_class_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_constant_string_interface
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_encoding_for_function_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_encoding_for_method_parameter
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_encoding_for_property_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_encoding_for_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_encoding_for_type_qualifier
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_id_redefinition_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_id_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_instance_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_object_pointer_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_proto_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_sel_redefinition_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_sel_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_c_super_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_cgc_attr_kind
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_cgc_qual_type
import krapper.krapper_parse.internal.clang_ASTContext_get_obj_cns_string_type
import krapper.krapper_parse.internal.clang_ASTContext_get_open_cl_type_addr_space
import krapper.krapper_parse.internal.clang_ASTContext_get_open_cl_type_kind
import krapper.krapper_parse.internal.clang_ASTContext_get_open_mp_default_simd_align
import krapper.krapper_parse.internal.clang_ASTContext_get_operator_delete_for_v_dtor
import krapper.krapper_parse.internal.clang_ASTContext_get_parameter_index
import krapper.krapper_parse.internal.clang_ASTContext_get_paren_type
import krapper.krapper_parse.internal.clang_ASTContext_get_pointer_auth_type_discriminator
import krapper.krapper_parse.internal.clang_ASTContext_get_pointer_auth_v_table_pointer_discriminator
import krapper.krapper_parse.internal.clang_ASTContext_get_pointer_diff_type
import krapper.krapper_parse.internal.clang_ASTContext_get_pointer_type
import krapper.krapper_parse.internal.clang_ASTContext_get_preferred_type_align
import krapper.krapper_parse.internal.clang_ASTContext_get_preferred_type_align__const_clang_Type_P
import krapper.krapper_parse.internal.clang_ASTContext_get_primary_merged_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_process_id_type
import krapper.krapper_parse.internal.clang_ASTContext_get_promoted_integer_type
import krapper.krapper_parse.internal.clang_ASTContext_get_r_value_reference_type
import krapper.krapper_parse.internal.clang_ASTContext_get_raw_cf_constant_string_type
import krapper.krapper_parse.internal.clang_ASTContext_get_read_pipe_type
import krapper.krapper_parse.internal.clang_ASTContext_get_real_type_for_bitwidth
import krapper.krapper_parse.internal.clang_ASTContext_get_restrict_type
import krapper.krapper_parse.internal.clang_ASTContext_get_scalable_vector_type
import krapper.krapper_parse.internal.clang_ASTContext_get_side_table_allocated_memory
import krapper.krapper_parse.internal.clang_ASTContext_get_signature_parameter_type
import krapper.krapper_parse.internal.clang_ASTContext_get_signed_size_type
import krapper.krapper_parse.internal.clang_ASTContext_get_signed_w_char_type
import krapper.krapper_parse.internal.clang_ASTContext_get_size_type
import krapper.krapper_parse.internal.clang_ASTContext_get_static_local_number
import krapper.krapper_parse.internal.clang_ASTContext_get_string_literal_array_type
import krapper.krapper_parse.internal.clang_ASTContext_get_subst_builtin_template_pack
import krapper.krapper_parse.internal.clang_ASTContext_get_subst_template_type_parm_pack_type
import krapper.krapper_parse.internal.clang_ASTContext_get_target_address_space
import krapper.krapper_parse.internal.clang_ASTContext_get_target_default_align_for_attribute_aligned
import krapper.krapper_parse.internal.clang_ASTContext_get_target_null_pointer_value
import krapper.krapper_parse.internal.clang_ASTContext_get_template_type_parm_type
import krapper.krapper_parse.internal.clang_ASTContext_get_translation_unit_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_type_align
import krapper.krapper_parse.internal.clang_ASTContext_get_type_align__const_clang_Type_P
import krapper.krapper_parse.internal.clang_ASTContext_get_type_align_if_known
import krapper.krapper_parse.internal.clang_ASTContext_get_type_decl_type__const_clang_TypeDecl_P
import krapper.krapper_parse.internal.clang_ASTContext_get_type_of_type
import krapper.krapper_parse.internal.clang_ASTContext_get_type_size
import krapper.krapper_parse.internal.clang_ASTContext_get_type_size__const_clang_Type_P
import krapper.krapper_parse.internal.clang_ASTContext_get_type_unadjusted_align
import krapper.krapper_parse.internal.clang_ASTContext_get_type_unadjusted_align__const_clang_Type_P
import krapper.krapper_parse.internal.clang_ASTContext_get_typedef_name_for_unnamed_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_u_int_ptr_type
import krapper.krapper_parse.internal.clang_ASTContext_get_unary_transform_type
import krapper.krapper_parse.internal.clang_ASTContext_get_unconstrained_type
import krapper.krapper_parse.internal.clang_ASTContext_get_unqualified_array_type__clang_QualType
import krapper.krapper_parse.internal.clang_ASTContext_get_unqualified_obj_c_pointer_type
import krapper.krapper_parse.internal.clang_ASTContext_get_unsigned_pointer_diff_type
import krapper.krapper_parse.internal.clang_ASTContext_get_unsigned_w_char_type
import krapper.krapper_parse.internal.clang_ASTContext_get_va_list_tag_decl
import krapper.krapper_parse.internal.clang_ASTContext_get_variable_array_decayed_type
import krapper.krapper_parse.internal.clang_ASTContext_get_vector_type
import krapper.krapper_parse.internal.clang_ASTContext_get_volatile_type
import krapper.krapper_parse.internal.clang_ASTContext_get_w_char_type
import krapper.krapper_parse.internal.clang_ASTContext_get_w_int_type
import krapper.krapper_parse.internal.clang_ASTContext_get_web_assembly_externref_type
import krapper.krapper_parse.internal.clang_ASTContext_get_wide_char_type
import krapper.krapper_parse.internal.clang_ASTContext_get_write_pipe_type
import krapper.krapper_parse.internal.clang_ASTContext_getcuda_configure_call_decl
import krapper.krapper_parse.internal.clang_ASTContext_getcuda_get_parameter_buffer_decl
import krapper.krapper_parse.internal.clang_ASTContext_getcuda_launch_device_decl
import krapper.krapper_parse.internal.clang_ASTContext_getjmp_buf_type
import krapper.krapper_parse.internal.clang_ASTContext_getsigjmp_buf_type
import krapper.krapper_parse.internal.clang_ASTContext_getucontext_t_type
import krapper.krapper_parse.internal.clang_ASTContext_has_any_function_effects
import krapper.krapper_parse.internal.clang_ASTContext_has_cvr_similar_type
import krapper.krapper_parse.internal.clang_ASTContext_has_direct_ownership_qualifier
import krapper.krapper_parse.internal.clang_ASTContext_has_same_function_type_ignoring_exception_spec
import krapper.krapper_parse.internal.clang_ASTContext_has_same_function_type_ignoring_param_abi
import krapper.krapper_parse.internal.clang_ASTContext_has_same_function_type_ignoring_ptr_sizes
import krapper.krapper_parse.internal.clang_ASTContext_has_same_nullability_type_qualifier
import krapper.krapper_parse.internal.clang_ASTContext_has_same_type
import krapper.krapper_parse.internal.clang_ASTContext_has_same_type__const_clang_Type_P_const_clang_Type_P
import krapper.krapper_parse.internal.clang_ASTContext_has_same_unqualified_type
import krapper.krapper_parse.internal.clang_ASTContext_has_seen_type_aware_operator_new_or_delete
import krapper.krapper_parse.internal.clang_ASTContext_has_similar_type
import krapper.krapper_parse.internal.clang_ASTContext_has_unique_object_representations
import krapper.krapper_parse.internal.clang_ASTContext_is_alignment_required
import krapper.krapper_parse.internal.clang_ASTContext_is_alignment_required__clang_QualType
import krapper.krapper_parse.internal.clang_ASTContext_is_dependence_allowed
import krapper.krapper_parse.internal.clang_ASTContext_is_destroying_operator_delete
import krapper.krapper_parse.internal.clang_ASTContext_is_ms_static_data_member_inline_definition
import krapper.krapper_parse.internal.clang_ASTContext_is_nearly_empty
import krapper.krapper_parse.internal.clang_ASTContext_is_obj_c_class_type
import krapper.krapper_parse.internal.clang_ASTContext_is_obj_c_id_type
import krapper.krapper_parse.internal.clang_ASTContext_is_obj_c_sel_type
import krapper.krapper_parse.internal.clang_ASTContext_is_obj_cns_object_type
import krapper.krapper_parse.internal.clang_ASTContext_is_promotable_integer_type
import krapper.krapper_parse.internal.clang_ASTContext_is_representable_integer_value
import krapper.krapper_parse.internal.clang_ASTContext_is_same_default_template_argument
import krapper.krapper_parse.internal.clang_ASTContext_is_same_entity
import krapper.krapper_parse.internal.clang_ASTContext_is_same_template_argument
import krapper.krapper_parse.internal.clang_ASTContext_is_same_template_parameter
import krapper.krapper_parse.internal.clang_ASTContext_is_same_template_parameter_list
import krapper.krapper_parse.internal.clang_ASTContext_is_type_aware_operator_new_or_delete
import krapper.krapper_parse.internal.clang_ASTContext_make_int_value
import krapper.krapper_parse.internal.clang_ASTContext_may_externalize
import krapper.krapper_parse.internal.clang_ASTContext_merge_function_parameter_types
import krapper.krapper_parse.internal.clang_ASTContext_merge_function_types
import krapper.krapper_parse.internal.clang_ASTContext_merge_obj_cgc_qualifiers
import krapper.krapper_parse.internal.clang_ASTContext_merge_tag_definitions
import krapper.krapper_parse.internal.clang_ASTContext_merge_transparent_union_type
import krapper.krapper_parse.internal.clang_ASTContext_merge_types
import krapper.krapper_parse.internal.clang_ASTContext_overridden_methods_size
import krapper.krapper_parse.internal.clang_ASTContext_print_stats
import krapper.krapper_parse.internal.clang_ASTContext_property_types_are_compatible
import krapper.krapper_parse.internal.clang_ASTContext_register_sycl_entry_point_function
import krapper.krapper_parse.internal.clang_ASTContext_remove_addr_space_qual_type
import krapper.krapper_parse.internal.clang_ASTContext_remove_ptr_size_addr_space
import krapper.krapper_parse.internal.clang_ASTContext_set_cf_constant_string_type
import krapper.krapper_parse.internal.clang_ASTContext_set_class_needs_vector_deleting_destructor
import krapper.krapper_parse.internal.clang_ASTContext_set_file_decl
import krapper.krapper_parse.internal.clang_ASTContext_set_instantiated_from_static_data_member
import krapper.krapper_parse.internal.clang_ASTContext_set_instantiated_from_unnamed_field_decl
import krapper.krapper_parse.internal.clang_ASTContext_set_instantiated_from_using_decl
import krapper.krapper_parse.internal.clang_ASTContext_set_is_destroying_operator_delete
import krapper.krapper_parse.internal.clang_ASTContext_set_is_type_aware_operator_new_or_delete
import krapper.krapper_parse.internal.clang_ASTContext_set_mangling_number
import krapper.krapper_parse.internal.clang_ASTContext_set_non_key_function
import krapper.krapper_parse.internal.clang_ASTContext_set_obj_c_class_redefinition_type
import krapper.krapper_parse.internal.clang_ASTContext_set_obj_c_id_redefinition_type
import krapper.krapper_parse.internal.clang_ASTContext_set_obj_c_sel_redefinition_type
import krapper.krapper_parse.internal.clang_ASTContext_set_obj_c_super_type
import krapper.krapper_parse.internal.clang_ASTContext_set_obj_cns_string_type
import krapper.krapper_parse.internal.clang_ASTContext_set_parameter_index
import krapper.krapper_parse.internal.clang_ASTContext_set_primary_merged_decl
import krapper.krapper_parse.internal.clang_ASTContext_set_static_local_number
import krapper.krapper_parse.internal.clang_ASTContext_set_traversal_scope
import krapper.krapper_parse.internal.clang_ASTContext_setcuda_configure_call_decl
import krapper.krapper_parse.internal.clang_ASTContext_setcuda_get_parameter_buffer_decl
import krapper.krapper_parse.internal.clang_ASTContext_setcuda_launch_device_decl
import krapper.krapper_parse.internal.clang_ASTContext_setjmp_buf_decl
import krapper.krapper_parse.internal.clang_ASTContext_setsigjmp_buf_decl
import krapper.krapper_parse.internal.clang_ASTContext_setucontext_t_decl
import krapper.krapper_parse.internal.clang_ASTContext_should_externalize
import krapper.krapper_parse.internal.clang_ASTContext_size_of
import krapper.krapper_parse.internal.clang_ASTContext_types_are_block_pointer_compatible
import krapper.krapper_parse.internal.clang_ASTContext_types_are_compatible
import krapper.krapper_parse.internal.clang_ASTContext_unwrap_similar_array_types
import krapper.krapper_parse.internal.clang_ASTContext_unwrap_similar_types
import llvm.APSInt
...
class ASTContext(
    ...
    inline fun setInstantiatedFromStaticDataMember(Inst: VarDeclApi?, Tmpl: VarDeclApi?, TSK: TemplateSpecializationKind): Unit {
        return clang_ASTContext_set_instantiated_from_static_data_member(ptr, Inst?.ptr, Tmpl?.ptr, TSK.value)
    }
    ...
    inline fun overridden_methods_size(Method: CXXMethodDeclApi?): UInt {
        return clang_ASTContext_overridden_methods_size(ptr, Method?.ptr)
    }
    inline fun addOverriddenMethod(Method: CXXMethodDeclApi?, Overridden: CXXMethodDeclApi?): Unit {
    ...
    inline fun getPointerAuthVTablePointerDiscriminator(RD: CXXRecordDeclApi?): UShort {
    ...
    inline fun getOpenCLTypeKind(T: TypeApi?): UByte {
        return clang_ASTContext_get_open_cl_type_kind(ptr, T?.ptr)
    }
    inline fun getOpenCLTypeAddrSpace(T: TypeApi?): LangAS {
        return CompanionfromValue(clang_ASTContext_get_open_cl_type_addr_space(ptr, T?.ptr))
    }
    ...
    inline fun BlockRequiresCopying(Ty: QualType, D: VarDeclApi?): Boolean {
        return clang_ASTContext_block_requires_copying(ptr, Ty.ptr, D?.ptr)
    }
    ...
    inline fun isRepresentableIntegerValue(Value: APSInt, T: QualType): Boolean {
        return clang_ASTContext_is_representable_integer_value(ptr, Value.ptr, T.ptr)
    }
    ...
    inline fun getSubstTemplateTypeParmPackType(AssociatedDecl: DeclApi?, Index: UInt, Final: Boolean, ArgPack: TemplateArgument): QualType {
        val retValue: QualType = memScope.QualType_Holder()
        clang_ASTContext_get_subst_template_type_parm_pack_type(ptr, AssociatedDecl?.ptr, Index, Final, ArgPack.ptr, retValue.ptr)
        return retValue
    }
    inline fun getSubstBuiltinTemplatePack(ArgPack: TemplateArgument): QualType {
        val retValue: QualType = memScope.QualType_Holder()
        clang_ASTContext_get_subst_builtin_template_pack(ptr, ArgPack.ptr, retValue.ptr)
        return retValue
    }
    inline fun getTemplateTypeParmType(Depth: UInt, Index: UInt, ParameterPack: Boolean, ParmDecl: TemplateTypeParmDecl? = null): QualType {
        val retValue: QualType = memScope.QualType_Holder()
        clang_ASTContext_get_template_type_parm_type(ptr, Depth, Index, ParameterPack, ParmDecl?.ptr, retValue.ptr)
        return retValue
    }
    ...
    inline fun getInjectedTemplateArg(ParamDecl: NamedDeclApi?): TemplateArgument {
        val retValue: TemplateArgument = memScope.TemplateArgument_Holder()
        clang_ASTContext_get_injected_template_arg(ptr, ParamDecl?.ptr, retValue.ptr)
        return retValue
    }
    ...
    inline fun getAutoType(DeducedType: QualType, Keyword: AutoTypeKeyword, IsDependent: Boolean, IsPack: Boolean = false, TypeConstraintConcept: TemplateDecl? = null): QualType {
        val retValue: QualType = memScope.QualType_Holder()
        clang_ASTContext_get_auto_type(ptr, DeducedType.ptr, Keyword.value, IsDependent, IsPack, TypeConstraintConcept?.ptr, retValue.ptr)
        return retValue
    }
    ...
    inline fun getTypeSize__const_clang_Type_P(T: TypeApi?): ULong {
        return clang_ASTContext_get_type_size__const_clang_Type_P(ptr, T?.ptr)
    }
    ...
    inline fun getTypeAlign__const_clang_Type_P(T: TypeApi?): UInt {
        return clang_ASTContext_get_type_align__const_clang_Type_P(ptr, T?.ptr)
    }
    inline fun getTypeUnadjustedAlign(T: QualType): UInt {
        return clang_ASTContext_get_type_unadjusted_align(ptr, T.ptr)
    }
    inline fun getTypeUnadjustedAlign__const_clang_Type_P(T: TypeApi?): UInt {
        return clang_ASTContext_get_type_unadjusted_align__const_clang_Type_P(ptr, T?.ptr)
    }
    ...
    inline fun isAlignmentRequired__const_clang_Type_P(T: TypeApi?): Boolean {
        return clang_ASTContext_is_alignment_required(ptr, T?.ptr)
    }
    ...
    inline fun getPreferredTypeAlign__const_clang_Type_P(T: TypeApi?): UInt {
        return clang_ASTContext_get_preferred_type_align__const_clang_Type_P(ptr, T?.ptr)
    }
    ...
    inline fun getAlignOfGlobalVar(T: QualType, VD: VarDeclApi?): UInt {
        return clang_ASTContext_get_align_of_global_var(ptr, T.ptr, VD?.ptr)
    }
    inline fun getMinGlobalAlignOfVar(Size: ULong, VD: VarDeclApi?): UInt {
        return clang_ASTContext_get_min_global_align_of_var(ptr, Size, VD?.ptr)
    }
    inline fun defaultsToMsStruct(): Boolean {
        return clang_ASTContext_defaults_to_ms_struct(ptr)
    }
    inline fun getCurrentKeyFunction(RD: CXXRecordDeclApi?): CXXMethodDeclApi? {
        return CXXMethodDecl((clang_ASTContext_get_current_key_function(ptr, RD?.ptr) ?: return null), memScope)
    }
    inline fun setNonKeyFunction(method: CXXMethodDeclApi?): Unit {
    ...
    inline fun isNearlyEmpty(RD: CXXRecordDeclApi?): Boolean {
    ...
    inline fun isSameTemplateParameterList(X: TemplateParameterList?, Y: TemplateParameterList?): Boolean {
        return clang_ASTContext_is_same_template_parameter_list(ptr, X?.ptr, Y?.ptr)
    }
    ...
    inline fun getCanonicalTemplateArgument(Arg: TemplateArgument): TemplateArgument {
        val retValue: TemplateArgument = memScope.TemplateArgument_Holder()
        clang_ASTContext_get_canonical_template_argument(ptr, Arg.ptr, retValue.ptr)
        return retValue
    }
    inline fun isSameTemplateArgument(Arg1: TemplateArgument, Arg2: TemplateArgument): Boolean {
        return clang_ASTContext_is_same_template_argument(ptr, Arg1.ptr, Arg2.ptr)
    }
    inline fun getAsArrayType(T: QualType): ArrayTypeApi? {
        return ArrayType((clang_ASTContext_get_as_array_type(ptr, T.ptr) ?: return null), memScope)
    }
    inline fun getAsConstantArrayType(T: QualType): ConstantArrayType? {
        return ConstantArrayType((clang_ASTContext_get_as_constant_array_type(ptr, T.ptr) ?: return null), memScope)
    }
    inline fun getBaseElementType__const_clang_ArrayType_P(VAT: ArrayTypeApi?): QualType {
        val retValue: QualType = memScope.QualType_Holder()
        clang_ASTContext_get_base_element_type(ptr, VAT?.ptr, retValue.ptr)
        return retValue
    }
    ...
    inline fun getConstantArrayElementCount(CA: ConstantArrayType?): ULong {
        return clang_ASTContext_get_constant_array_element_count(ptr, CA?.ptr)
    }
    ...
    inline fun MakeIntValue(Value: ULong, Type: QualType): APSInt {
        val retValue: APSInt = memScope.APSInt_Holder()
        clang_ASTContext_make_int_value(ptr, Value, Type.ptr, retValue.ptr)
        return retValue
    }
    ...
    inline fun GetGVALinkageForVariable(VD: VarDeclApi?): GVALinkage {
        return GVALinkageCompanionfromValue(clang_ASTContext_get_gva_linkage_for_variable(ptr, VD?.ptr))
    }
    inline fun DeclMustBeEmitted(D: DeclApi?): Boolean {
        return clang_ASTContext_decl_must_be_emitted(ptr, D?.ptr)
    }
    inline fun getCopyConstructorForExceptionObject(RD: CXXRecordDeclApi?): CXXConstructorDecl? {
        return CXXConstructorDecl((clang_ASTContext_get_copy_constructor_for_exception_object(ptr, RD?.ptr) ?: return null), memScope)
    }
    inline fun addCopyConstructorForExceptionObject(RD: CXXRecordDeclApi?, CD: CXXConstructorDecl?): Unit {
        return clang_ASTContext_add_copy_constructor_for_exception_object(ptr, RD?.ptr, CD?.ptr)
    }
    inline fun addTypedefNameForUnnamedTagDecl(TD: TagDeclApi?, TND: TypedefNameDecl?): Unit {
        return clang_ASTContext_add_typedef_name_for_unnamed_tag_decl(ptr, TD?.ptr, TND?.ptr)
    }
    inline fun getTypedefNameForUnnamedTagDecl(TD: TagDeclApi?): TypedefNameDecl? {
        return TypedefNameDecl((clang_ASTContext_get_typedef_name_for_unnamed_tag_decl(ptr, TD?.ptr) ?: return null), memScope)
    }
    ...
    inline fun setStaticLocalNumber(VD: VarDeclApi?, Number: UInt): Unit {
        return clang_ASTContext_set_static_local_number(ptr, VD?.ptr, Number)
    }
    inline fun getStaticLocalNumber(VD: VarDeclApi?): UInt {
        return clang_ASTContext_get_static_local_number(ptr, VD?.ptr)
    }
    ...
    inline fun addOperatorDeleteForVDtor(Dtor: CXXDestructorDecl?, OperatorDelete: FunctionDeclApi?, K: OperatorDeleteKind): Unit {
        return clang_ASTContext_add_operator_delete_for_v_dtor(ptr, Dtor?.ptr, OperatorDelete?.ptr, K.value)
    }
    inline fun getOperatorDeleteForVDtor(Dtor: CXXDestructorDecl?, K: OperatorDeleteKind): FunctionDeclApi? {
        return FunctionDecl((clang_ASTContext_get_operator_delete_for_v_dtor(ptr, Dtor?.ptr, K.value) ?: return null), memScope)
    }
    inline fun dtorHasOperatorDelete(Dtor: CXXDestructorDecl?, K: OperatorDeleteKind): Boolean {
        return clang_ASTContext_dtor_has_operator_delete(ptr, Dtor?.ptr, K.value)
    }
    inline fun setClassNeedsVectorDeletingDestructor(RD: CXXRecordDeclApi?): Unit {
        return clang_ASTContext_set_class_needs_vector_deleting_destructor(ptr, RD?.ptr)
    }
    inline fun classNeedsVectorDeletingDestructor(RD: CXXRecordDeclApi?): Boolean {
        return clang_ASTContext_class_needs_vector_deleting_destructor(ptr, RD?.ptr)
    }
    inline fun setParameterIndex(D: ParmVarDecl?, index: UInt): Unit {
        return clang_ASTContext_set_parameter_index(ptr, D?.ptr, index)
    }
    inline fun getParameterIndex(D: ParmVarDecl?): UInt {
        return clang_ASTContext_get_parameter_index(ptr, D?.ptr)
    }
    ...
    inline fun isMSStaticDataMemberInlineDefinition(VD: VarDeclApi?): Boolean {
        return clang_ASTContext_is_ms_static_data_member_inline_definition(ptr, VD?.ptr)
    }
    inline fun getInlineVariableDefinitionKind(VD: VarDeclApi?): InlineVariableDefinitionKind {
        return InlineVariableDefinitionKindCompanionfromValue(clang_ASTContext_get_inline_variable_definition_kind(ptr, VD?.ptr))
    }
    ...
    inline fun baseForVTableAuthentication(ThisClass: CXXRecordDeclApi?): CXXRecordDeclApi? {
    ...
    companion object {
        ...
        inline fun MemScope.getCanonicalType(T: TypeApi?): TypeApi? {
            return Type((clang_ASTContext_get_canonical_type(T?.ptr) ?: return null), memScope)
        }
        inline fun MemScope.hasSameType(T1: QualType, T2: QualType): Boolean {
            return clang_ASTContext_has_same_type(T1.ptr, T2.ptr)
        }
        inline fun MemScope._hasSameType(T1: TypeApi?, T2: TypeApi?): Boolean {
            return clang_ASTContext_has_same_type__const_clang_Type_P_const_clang_Type_P(T1?.ptr, T2?.ptr)
        }
