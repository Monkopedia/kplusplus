...
import krapper.krapper_parse.internal.clang_DeclContext_add_decl
import krapper.krapper_parse.internal.clang_DeclContext_add_decl_internal
import krapper.krapper_parse.internal.clang_DeclContext_add_hidden_decl
import krapper.krapper_parse.internal.clang_DeclContext_align_of
import krapper.krapper_parse.internal.clang_DeclContext_classof
import krapper.krapper_parse.internal.clang_DeclContext_classof__const_clang_DeclContext_P
import krapper.krapper_parse.internal.clang_DeclContext_contains_decl
import krapper.krapper_parse.internal.clang_DeclContext_contains_decl_and_load
import krapper.krapper_parse.internal.clang_DeclContext_decls
import krapper.krapper_parse.internal.clang_DeclContext_decls_empty
import krapper.krapper_parse.internal.clang_DeclContext_dispose
import krapper.krapper_parse.internal.clang_DeclContext_dump_as_decl
import krapper.krapper_parse.internal.clang_DeclContext_dump_as_decl__const_clang_ASTContext_P
import krapper.krapper_parse.internal.clang_DeclContext_dump_decl_context
import krapper.krapper_parse.internal.clang_DeclContext_dump_lookups
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_CXXConstructorDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_CXXDestructorDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_CXXMethodDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_CXXRecordDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_ClassTemplateSpecializationDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_EnumDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_FunctionDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_NamespaceDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_RecordDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_TagDecl
import krapper.krapper_parse.internal.clang_DeclContext_dyncast_clang_TranslationUnitDecl
import krapper.krapper_parse.internal.clang_DeclContext_encloses
import krapper.krapper_parse.internal.clang_DeclContext_equals
import krapper.krapper_parse.internal.clang_DeclContext_get_decl_kind
import krapper.krapper_parse.internal.clang_DeclContext_get_decl_kind_name
import krapper.krapper_parse.internal.clang_DeclContext_get_enclosing_namespace_context
import krapper.krapper_parse.internal.clang_DeclContext_get_lexical_parent
import krapper.krapper_parse.internal.clang_DeclContext_get_lookup_parent
import krapper.krapper_parse.internal.clang_DeclContext_get_non_closure_ancestor
import krapper.krapper_parse.internal.clang_DeclContext_get_non_transparent_context
import krapper.krapper_parse.internal.clang_DeclContext_get_outer_lexical_record_context
import krapper.krapper_parse.internal.clang_DeclContext_get_parent
import krapper.krapper_parse.internal.clang_DeclContext_get_parent_ast_context
import krapper.krapper_parse.internal.clang_DeclContext_get_primary_context
import krapper.krapper_parse.internal.clang_DeclContext_get_redecl_context
import krapper.krapper_parse.internal.clang_DeclContext_has_external_lexical_storage
import krapper.krapper_parse.internal.clang_DeclContext_has_external_visible_storage
import krapper.krapper_parse.internal.clang_DeclContext_has_valid_decl_kind
import krapper.krapper_parse.internal.clang_DeclContext_in_enclosing_namespace_set_of
import krapper.krapper_parse.internal.clang_DeclContext_is_closure
import krapper.krapper_parse.internal.clang_DeclContext_is_decl_in_lexical_traversal
import krapper.krapper_parse.internal.clang_DeclContext_is_dependent_context
import krapper.krapper_parse.internal.clang_DeclContext_is_extern_c_context
import krapper.krapper_parse.internal.clang_DeclContext_is_extern_cxx_context
import krapper.krapper_parse.internal.clang_DeclContext_is_file_context
import krapper.krapper_parse.internal.clang_DeclContext_is_function_or_method
import krapper.krapper_parse.internal.clang_DeclContext_is_inline_namespace
import krapper.krapper_parse.internal.clang_DeclContext_is_lookup_context
import krapper.krapper_parse.internal.clang_DeclContext_is_namespace
import krapper.krapper_parse.internal.clang_DeclContext_is_obj_c_container
import krapper.krapper_parse.internal.clang_DeclContext_is_record
import krapper.krapper_parse.internal.clang_DeclContext_is_requires_expr_body
import krapper.krapper_parse.internal.clang_DeclContext_is_std_namespace
import krapper.krapper_parse.internal.clang_DeclContext_is_translation_unit
import krapper.krapper_parse.internal.clang_DeclContext_is_transparent_context
import krapper.krapper_parse.internal.clang_DeclContext_lexically_encloses
import krapper.krapper_parse.internal.clang_DeclContext_make_decl_visible_in_context
import krapper.krapper_parse.internal.clang_DeclContext_noload_decls
import krapper.krapper_parse.internal.clang_DeclContext_remove_decl
import krapper.krapper_parse.internal.clang_DeclContext_set_has_external_lexical_storage
import krapper.krapper_parse.internal.clang_DeclContext_set_has_external_visible_storage
import krapper.krapper_parse.internal.clang_DeclContext_set_must_build_lookup_table
import krapper.krapper_parse.internal.clang_DeclContext_set_use_qualified_lookup
import krapper.krapper_parse.internal.clang_DeclContext_should_use_qualified_lookup
import krapper.krapper_parse.internal.clang_DeclContext_size_of
...
class DeclContext(
    ...
    inline fun asEnumDecl(): EnumDecl? {
        val raw: COpaquePointer = (clang_DeclContext_dyncast_clang_EnumDecl(ptr) ?: return null)
    ...
    inline fun asCXXConstructorDecl(): CXXConstructorDecl? {
        val raw: COpaquePointer = (clang_DeclContext_dyncast_clang_CXXConstructorDecl(ptr) ?: return null)
        return CXXConstructorDecl(raw, memScope)
    }
    inline fun asCXXDestructorDecl(): CXXDestructorDecl? {
        val raw: COpaquePointer = (clang_DeclContext_dyncast_clang_CXXDestructorDecl(ptr) ?: return null)
        return CXXDestructorDecl(raw, memScope)
    }
    inline fun asClassTemplateSpecializationDecl(): ClassTemplateSpecializationDecl? {
        val raw: COpaquePointer = (clang_DeclContext_dyncast_clang_ClassTemplateSpecializationDecl(ptr) ?: return null)
    ...
    inline fun asNamespaceDecl(): NamespaceDecl? {
        val raw: COpaquePointer = (clang_DeclContext_dyncast_clang_NamespaceDecl(ptr) ?: return null)
