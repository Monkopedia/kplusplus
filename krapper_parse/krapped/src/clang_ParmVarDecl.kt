...
import krapper.krapper_parse.internal._clang_VarDecl_get_definition
import krapper.krapper_parse.internal._clang_VarDecl_has_definition
import krapper.krapper_parse.internal._clang_VarDecl_is_this_declaration_a_definition
...
import krapper.krapper_parse.internal.clang_NamedDecl_get_most_recent_decl
...
import krapper.krapper_parse.internal.clang_ParmVarDecl_align_of
import krapper.krapper_parse.internal.clang_ParmVarDecl_as_clang_Decl
import krapper.krapper_parse.internal.clang_ParmVarDecl_as_clang_DeclaratorDecl
import krapper.krapper_parse.internal.clang_ParmVarDecl_as_clang_NamedDecl
import krapper.krapper_parse.internal.clang_ParmVarDecl_as_clang_ValueDecl
import krapper.krapper_parse.internal.clang_ParmVarDecl_as_clang_VarDecl
import krapper.krapper_parse.internal.clang_ParmVarDecl_classof
import krapper.krapper_parse.internal.clang_ParmVarDecl_classof_kind
import krapper.krapper_parse.internal.clang_ParmVarDecl_get_function_scope_depth
import krapper.krapper_parse.internal.clang_ParmVarDecl_get_function_scope_index
import krapper.krapper_parse.internal.clang_ParmVarDecl_get_max_function_scope_depth
import krapper.krapper_parse.internal.clang_ParmVarDecl_get_obj_c_decl_qualifier
import krapper.krapper_parse.internal.clang_ParmVarDecl_get_original_type
import krapper.krapper_parse.internal.clang_ParmVarDecl_has_default_arg
import krapper.krapper_parse.internal.clang_ParmVarDecl_has_inherited_default_arg
import krapper.krapper_parse.internal.clang_ParmVarDecl_has_uninstantiated_default_arg
import krapper.krapper_parse.internal.clang_ParmVarDecl_has_unparsed_default_arg
import krapper.krapper_parse.internal.clang_ParmVarDecl_is_destroyed_in_callee
import krapper.krapper_parse.internal.clang_ParmVarDecl_is_explicit_object_parameter
import krapper.krapper_parse.internal.clang_ParmVarDecl_is_knr_promoted
import krapper.krapper_parse.internal.clang_ParmVarDecl_is_obj_c_method_parameter
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_has_inherited_default_arg
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_knr_promoted
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_obj_c_decl_qualifier
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_obj_c_method_scope_info
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_owning_function
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_scope_info
import krapper.krapper_parse.internal.clang_ParmVarDecl_set_unparsed_default_arg
import krapper.krapper_parse.internal.clang_ParmVarDecl_size_of
...
import krapper.krapper_parse.internal.clang_VarDecl_demote_this_definition_to_declaration
import krapper.krapper_parse.internal.clang_VarDecl_get_acting_definition
import krapper.krapper_parse.internal.clang_VarDecl_get_canonical_decl
import krapper.krapper_parse.internal.clang_VarDecl_get_definition
import krapper.krapper_parse.internal.clang_VarDecl_get_init_style
import krapper.krapper_parse.internal.clang_VarDecl_get_initializing_declaration
import krapper.krapper_parse.internal.clang_VarDecl_get_instantiated_from_static_data_member
import krapper.krapper_parse.internal.clang_VarDecl_get_language_linkage
import krapper.krapper_parse.internal.clang_VarDecl_get_storage_class
import krapper.krapper_parse.internal.clang_VarDecl_get_storage_duration
import krapper.krapper_parse.internal.clang_VarDecl_get_template_instantiation_pattern
import krapper.krapper_parse.internal.clang_VarDecl_get_template_specialization_kind
import krapper.krapper_parse.internal.clang_VarDecl_get_template_specialization_kind_for_instantiation
import krapper.krapper_parse.internal.clang_VarDecl_get_tls_kind
import krapper.krapper_parse.internal.clang_VarDecl_get_tsc_spec
import krapper.krapper_parse.internal.clang_VarDecl_has_constant_initialization
import krapper.krapper_parse.internal.clang_VarDecl_has_definition
import krapper.krapper_parse.internal.clang_VarDecl_has_dependent_alignment
import krapper.krapper_parse.internal.clang_VarDecl_has_external_storage
import krapper.krapper_parse.internal.clang_VarDecl_has_flexible_array_init
import krapper.krapper_parse.internal.clang_VarDecl_has_global_storage
import krapper.krapper_parse.internal.clang_VarDecl_has_ice_initializer
import krapper.krapper_parse.internal.clang_VarDecl_has_init
import krapper.krapper_parse.internal.clang_VarDecl_has_init_with_side_effects
import krapper.krapper_parse.internal.clang_VarDecl_has_local_storage
import krapper.krapper_parse.internal.clang_VarDecl_is_arc_pseudo_strong
import krapper.krapper_parse.internal.clang_VarDecl_is_constexpr
import krapper.krapper_parse.internal.clang_VarDecl_is_cxx_cond_decl
import krapper.krapper_parse.internal.clang_VarDecl_is_cxx_for_range_decl
import krapper.krapper_parse.internal.clang_VarDecl_is_cxx_for_range_implicit_var
import krapper.krapper_parse.internal.clang_VarDecl_is_direct_init
import krapper.krapper_parse.internal.clang_VarDecl_is_escaping_byref
import krapper.krapper_parse.internal.clang_VarDecl_is_exception_variable
import krapper.krapper_parse.internal.clang_VarDecl_is_extern_c
import krapper.krapper_parse.internal.clang_VarDecl_is_file_var_decl
import krapper.krapper_parse.internal.clang_VarDecl_is_function_or_method_var_decl
import krapper.krapper_parse.internal.clang_VarDecl_is_in_extern_c_context
import krapper.krapper_parse.internal.clang_VarDecl_is_in_extern_cxx_context
import krapper.krapper_parse.internal.clang_VarDecl_is_init_capture
import krapper.krapper_parse.internal.clang_VarDecl_is_inline
import krapper.krapper_parse.internal.clang_VarDecl_is_inline_specified
import krapper.krapper_parse.internal.clang_VarDecl_is_known_to_be_defined
import krapper.krapper_parse.internal.clang_VarDecl_is_local_var_decl
import krapper.krapper_parse.internal.clang_VarDecl_is_local_var_decl_or_parm
import krapper.krapper_parse.internal.clang_VarDecl_is_no_destroy
import krapper.krapper_parse.internal.clang_VarDecl_is_non_escaping_byref
import krapper.krapper_parse.internal.clang_VarDecl_is_nrvo_variable
import krapper.krapper_parse.internal.clang_VarDecl_is_obj_c_for_decl
import krapper.krapper_parse.internal.clang_VarDecl_is_out_of_line
import krapper.krapper_parse.internal.clang_VarDecl_is_previous_decl_in_same_block_scope
import krapper.krapper_parse.internal.clang_VarDecl_is_static_data_member
import krapper.krapper_parse.internal.clang_VarDecl_is_static_local
import krapper.krapper_parse.internal.clang_VarDecl_is_this_declaration_a_definition
import krapper.krapper_parse.internal.clang_VarDecl_is_this_declaration_a_demoted_definition
import krapper.krapper_parse.internal.clang_VarDecl_is_usable_in_constant_expressions
import krapper.krapper_parse.internal.clang_VarDecl_might_be_usable_in_constant_expressions
import krapper.krapper_parse.internal.clang_VarDecl_needs_destruction
import krapper.krapper_parse.internal.clang_VarDecl_set_arc_pseudo_strong
import krapper.krapper_parse.internal.clang_VarDecl_set_constexpr
import krapper.krapper_parse.internal.clang_VarDecl_set_cxx_cond_decl
import krapper.krapper_parse.internal.clang_VarDecl_set_cxx_for_range_decl
import krapper.krapper_parse.internal.clang_VarDecl_set_cxx_for_range_implicit_var
import krapper.krapper_parse.internal.clang_VarDecl_set_escaping_byref
import krapper.krapper_parse.internal.clang_VarDecl_set_exception_variable
import krapper.krapper_parse.internal.clang_VarDecl_set_implicitly_inline
import krapper.krapper_parse.internal.clang_VarDecl_set_init_capture
import krapper.krapper_parse.internal.clang_VarDecl_set_init_style
import krapper.krapper_parse.internal.clang_VarDecl_set_inline_specified
import krapper.krapper_parse.internal.clang_VarDecl_set_instantiation_of_static_data_member
import krapper.krapper_parse.internal.clang_VarDecl_set_nrvo_variable
import krapper.krapper_parse.internal.clang_VarDecl_set_obj_c_for_decl
import krapper.krapper_parse.internal.clang_VarDecl_set_previous_decl_in_same_block_scope
import krapper.krapper_parse.internal.clang_VarDecl_set_storage_class
import krapper.krapper_parse.internal.clang_VarDecl_set_template_specialization_kind
import krapper.krapper_parse.internal.clang_VarDecl_set_tsc_spec
